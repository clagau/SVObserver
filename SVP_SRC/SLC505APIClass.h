...
// * .File Name       : $Workfile:   SLC505APIClass.h  $
// * ----------------------------------------------------------------------------
// * .Current Version : $Revision:   1.0  $
// * .Check In Date   : $Date:   25 Apr 2013 15:37:16  $
// ******************************************************************************

#ifndef SVSLC505APIClass_H_INCLUDED
#define SVSLC505APIClass_H_INCLUDED
...
class SV_PLCAPI_DS SVSLC505APIClass : public SVRSLinxABPLCBaseClass
{
public:
   SVSLC505APIClass (long* aplErr);
   ~SVSLC505APIClass();
...
#endif // #ifndef SVSLC505APIClass_H_INCLUDED

// ******************************************************************************
// * LOG HISTORY:
// ******************************************************************************
/*
$Log:   N:\PVCSarch65\ProjectFiles\archives\SVObserver_src\SVP_SRC\SLC505APIClass.h_v  $
 * 
 *    Rev 1.0   25 Apr 2013 15:37:16   bWalter
 * Project:  SVObserver
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.1   14 Nov 2001 10:03:50   jBrown
 * Project:  SVFocusNT
