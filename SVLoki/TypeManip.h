...
//* All Rights Reserved
//******************************************************************************
//* .Module Name     : TypeManip.h
//* .File Name       : $Workfile:   TypeManip.h  $
//* ----------------------------------------------------------------------------
//* .Current Version : $Revision:   1.0  $
//* .Check In Date   : $Date:   22 Apr 2013 14:00:10  $
//******************************************************************************
...
//	This template is not in the original Loki-Library
	...
	{
		private:
			static Private::YES_ check(Type2Type<T>);
			static Private::NO_ check(...);
		public:
			enum {value = sizeof(check(Type2Type<U>())) == sizeof(Private::YES_)};
	};
////////////////////////////////////////////////////////////////////////////////
...
//******************************************************************************
/*
$Log:   N:\PVCSarch65\ProjectFiles\archives\SVObserver_SRC\SVLoki\TypeManip.h_v  $
 * 
 *    Rev 1.0   22 Apr 2013 14:00:10   bWalter
 * Project:  SVObserver
