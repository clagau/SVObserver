...
//* All Rights Reserved
//******************************************************************************
//* .Module Name     : SmallObj.cpp
//* .File Name       : $Workfile:   SmallObj.cpp  $
//* ----------------------------------------------------------------------------
//* .Current Version : $Revision:   1.0  $
//* .Check In Date   : $Date:   22 Apr 2013 13:55:50  $
//******************************************************************************
...
void* SmallObjAllocator::Allocate(VC_BROKEN_STD::size_t numBytes)
{
	...
	FixedAllocator f(numBytes);
	
    Pool::iterator i = std::lower_bound(pool_.begin(), pool_.end(), f);
...
{
    if (numBytes > maxObjectSize_) {free(p); return;}
...
//******************************************************************************
/*
$Log:   N:\PVCSarch65\ProjectFiles\archives\SVObserver_SRC\SVLoki\SmallObj.cpp_v  $
 * 
 *    Rev 1.0   22 Apr 2013 13:55:50   bWalter
 * Project:  SVObserver
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.2   04 Oct 2005 08:57:56   tbair
 * Project:  SVObserver
 * Change Request (SCR) nbr:  504
 * SCR Title:  Fix lock-up problem when pending product count is larger than PPQ size
 * Checked in by:  Joe;  Joe Spila
 * Change Description:  
 *   added #include "stdafx.h" to make it work better with projects. (This file must be included in the target library's project.)
 * changed new and delete to malloc and free to avoid potential recursive call (VC6 bug?)
 * fixed bug in VicinityFind - prevent endless loop if trying to free a bogus pointer.
 * 
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
