...
//* All Rights Reserved
//******************************************************************************
//* .Module Name     : TypeTraits
//* .File Name       : $Workfile:   TypeTraits.h  $
//* ----------------------------------------------------------------------------
//* .Current Version : $Revision:   1.0  $
//* .Check In Date   : $Date:   22 Apr 2013 14:00:14  $
//******************************************************************************
...
////////////////////////////////////////////////////////////////////////////////
	namespace Private
	{
		...
		YES_ IsConstTester(const volatile void*);
		NO_ IsConstTester(volatile void *);
		...
		struct IsConstImpl<false,false>
		{
			...
			{
				static T* t;
				enum {value = sizeof(YES_) == sizeof(IsConstTester(t))};
			};
		};
		template <>
		...
		YES_ IsVolatileTester(void const volatile*);
		NO_ IsVolatileTester(void const*);
		...
		struct IsVolatileImpl<false,false>
		{
			...
			{
				static T* t;
				enum {value = sizeof(YES_) == sizeof(IsVolatileTester(t))};
			};
		};
		...
		NO_	IsReferenceHelper1(...);

		template <class U>
		NO_	IsReferenceHelper2(U&(*)(::Loki::Type2Type<U>));
		YES_ IsReferenceHelper2(...);

		template <class U, class Z>
		YES_ IsPointer2Member(Z U::*);
		NO_	IsPointer2Member(...);
		...
		template<class U>
		NO_ IsArrayTester2(U(*)(::Loki::Type2Type<U>));
		YES_ IsArrayTester2(...);
		...
		// book "C++ Templates".
		template<class U> 
		NO_ IsFunctionPtrTester1(U*, U(*)[1] = 0);
		YES_ IsFunctionPtrTester1(...);
	}
	...
	public:
		...
		enum { isArray	= sizeof(Private::YES_) 
						== sizeof(Private::IsArrayTester2(
									Private::IsArrayTester1(::Loki::Type2Type<T>()))
							) 
		};
		
		enum { isReference	= sizeof(Private::YES_) 
	...
	private:
        ...
        private:
            ...
            static Private::YES_ check(BoolConvert);
            static Private::NO_ check(...);
        ...
        public:
			enum { value = sizeof(check(get())) == sizeof(Private::YES_) };
	...
	private:
		...
		enum { isMemberPointerTemp = sizeof(Private::YES_) 
									== sizeof(Private::IsPointer2Member(MakeT())) 
		};
	public:
		enum {isPointer = sizeof(Private::YES_) 
	...
	public:
		...
		enum { isEnum = sizeof(Private::YES_) 
		...
		enum { isFunctionPointer = sizeof(Private::YES_) 
								== sizeof(
...
//******************************************************************************
/*
$Log:   N:\PVCSarch65\ProjectFiles\archives\SVObserver_SRC\SVLoki\TypeTraits.h_v  $
 * 
 *    Rev 1.0   22 Apr 2013 14:00:14   bWalter
 * Project:  SVObserver
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.2   20 Jun 2005 10:05:16   ebeyeler
 * Project:  SVObserver
 * Change Request (SCR) nbr:  450
 * SCR Title:  Add asynchronous functionality to the archive tool
 * Checked in by:  eBeyeler;  Eric Beyeler
 * Change Description:  
 *   added _ to YES and NO to avoid conflicts with other 3rd party libraries that #define these two symbols
 * 
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.1   13 Jul 2004 08:52:16   ebeyeler
 * Project:  SVObserver
