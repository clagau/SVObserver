...
public:
	...
	/// \returns HRESULT
	static HRESULT CreateFriendObject(const GUID& classID, const GUID& uniqueID, const std::string& objectName, const GUID& ownerUniqueID, const GUID& rAddPreGuid = SV_GUID_NULL);
