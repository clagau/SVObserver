...
//* .Check In Date   : $Date:   25 Apr 2013 09:29:48  $
//******************************************************************************
...
void CSVPropertyPageCharsAndLabels::SendPenColorToEdit()
{
	...
	if(m_enumPixelEditorState == ENUM_EDIT_RUNNING)
	{
		...
		// abb (comment): seems to me the logic of this flag is backwards...
...
//******************************************************************************
/*
$Log:   N:\PVCSarch65\ProjectFiles\archives\SVObserver_src\SVOCRGrayFontTrain\SVPropertyPageCharsAndLabels.cpp_v  $
 * 
 *    Rev 1.0   25 Apr 2013 09:29:48   bWalter
 * Project:  SVObserver
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.0   16 May 2000 15:08:42   Joe
 * Project:  SVObserver
