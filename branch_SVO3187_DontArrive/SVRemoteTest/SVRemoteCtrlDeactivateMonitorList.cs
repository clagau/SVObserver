...
//* All Rights Reserved
//******************************************************************************
//* .Module Name     : SVRemoteCtrlDeactivateMonitorList
//* .File Name       : $Workfile:   SVRemoteCtrlDeactivateMonitorList.cs  $
//* ----------------------------------------------------------------------------
...
{
    public class SVRemoteCtrlDeactivateMonitorList : ISVComObjectView
    {
        #region Properties
...
//******************************************************************************
/*
$Log:   N:\PVCSarch65\ProjectFiles\archives\SVRemoteControl\SVRemoteTest\SVRemoteCtrlDeactivateMonitorList.cs_v  $
 * 
