...
static char* ReasonString[] =
{
  ...
  "FB: Frame",
  "FB: Debug",
	"FB: Frame Start"	// SVR - deviation from Standard Intek FireBus API
};
...
UINT8 CFireBus::GetIsoChannel(CCamera *pCamera)
{
  ...
  // SEJ - Fix IsoChannel assignment on bus reset in hub mode
  // FCTLIsoQueryResources appears to be returning the wrong value when anything other than camera1
  // is disconnected and re-connected, think it might be a threading issue...

  // SEJ - Check if in Bus Reset
  if (m_pContext && ((SVIntekBoardStruct*)m_pContext)->m_bFirstBusResetStarted)
  {
	// use IsoChannel from saved camera settings
	i = pCamera->pParms()->IsoChn;
...
UINT8 CFireBus::OpenIsoDma(CCamera *pCamera,FCTLLOCKMEMORY *pUserFrames)
{
  ...
  // SEJ - enable Packet level error detection
	Arg.DmaMode = 0;
	Arg.DmaFlags = FCTLIF_CHECKSYNC | FCTLIF_CHECKLENGTH | FCTLIF_FRMSTARTEX;
  // SVR - end deviation from Standard Intek FireBus API
  ...
  if(Result==FCE_NOERROR)
  {
    ...
    { 
      ...
      else
      {
		...
		{
			CallUser(FBN_FRAME_START,(void*)m_pIsoDevice[IsoChn]);
		}
		// SVR - end deviation from Standard Intek FireBus API
  }
	// SVR - deviation from Standard Intek FireBus API
...
////////////////////////////////////////////////////////////////////////////////
// Global get system information function.
////////////////////////////////////////////////////////////////////////////////
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.4   11 Apr 2007 10:43:32   sjones
 * Project:  SVObserver
 * Change Request (SCR) nbr:  582
 * SCR Title:  Upgrade Intek FireStack Driver and API to version 2.15
 * Checked in by:  sJones;  Steve Jones
 * Change Description:  
 *   Revised GetIsoChannel to fix problem with iso channel assignment during bus reset in hub mode
 * 
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.4   11 Apr 2007 10:40:24   sjones
 * Project:  SVObserver
 * Change Request (SCR) nbr:  582
 * SCR Title:  Upgrade Intek FireStack Driver and API to version 2.15
 * Checked in by:  sJones;  Steve Jones
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.3   26 Jan 2007 10:02:32   sjones
 * Project:  SVObserver
 * Change Request (SCR) nbr:  582
 * SCR Title:  Upgrade Intek FireStack Driver and API to version 2.15
 * Checked in by:  sJones;  Steve Jones
 * Change Description:  
 *   Revised to not use FCTL_CHECKCYCLE for the packet level error chacking.
 * 
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.2   28 Nov 2006 17:25:28   sjones
 * Project:  SVObserver
 * Change Request (SCR) nbr:  582
 * SCR Title:  Upgrade Intek FireStack Driver and API to version 2.15
 * Checked in by:  sJones;  Steve Jones
 ...
 * Enabled Packet Level error detection and handling
 * 
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.1   23 Mar 2006 08:13:46   Joe
 * Project:  SVObserver
 * Change Request (SCR) nbr:  552
 * SCR Title:  Fix problem with Intek driver when attaching multiple cameras to one board
 * Checked in by:  Joe;  Joe Spila
 * Change Description:  
 *   Updated code to move the licence validation right after the open function call.
 * 
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
