//******************************************************************************
//* .Module Name     : CCamera
//* .File Name       : $Workfile:   camera.h  $
//* ----------------------------------------------------------------------------
//* .Current Version : $Revision:   1.0  $
//* .Check In Date   : $Date:   29 Apr 2013 09:03:22  $
//******************************************************************************
...
enum{ TM_INTERN=0,TM_EXTERN, TM_EXTERN_RISING, TM_MODE15, TM_ONESHOT, TM_SOFTWARE, TM_LAST };
...
public:
  ...
  virtual UINT8  DoSoftwareTrigger(UINT32 ulRegister, UINT32 ulValue); // SVR Do Software Trigger (if supported)
...
//******************************************************************************
/*
$Log:   N:\PVCSarch65\ProjectFiles\archives\SVObserver_src\Intek\camera.h_v  $
 * 
 *    Rev 1.0   29 Apr 2013 09:03:22   bWalter
 * Project:  SVObserver
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.4   02 Nov 2009 19:01:10   jspila
 * Project:  SVObserver
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.3   15 Oct 2009 10:31:00   sjones
 * Project:  SVObserver
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.1   28 Nov 2006 17:20:44   sjones
 * Project:  SVObserver
 * Change Request (SCR) nbr:  582
 * SCR Title:  Upgrade Intek FireStack Driver and API to version 2.15
 * Checked in by:  sJones;  Steve Jones
 * Change Description:  
 *   Add comments around SVResearch revisions
 * 
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.0   14 Dec 2005 09:39:18   Joe
 * Project:  SVObserver
