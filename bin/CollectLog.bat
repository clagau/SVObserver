...
echo getting network info 192.168.15.1 ...
ping 192.168.15.1 -n 10 > c:\temp\log\ping1.log
echo getting network info 192.168.15.2 ...
ping 192.168.15.2 -n 10 > c:\temp\log\ping2.log
echo getting network info 192.168.15.3 ...
ping 192.168.15.3 -n 10 > c:\temp\log\ping3.log
echo getting network info 192.168.15.4 ...
ping 192.168.15.4 -n 5 > c:\temp\log\ping4.log
echo getting network info 192.168.15.5 ...
ping 192.168.15.5 -n 5 > c:\temp\log\ping5.log
echo getting network info 192.168.15.6 ...
ping 192.168.15.6 -n 5 > c:\temp\log\ping6.log
echo getting network info 192.168.15.7 ...
ping 192.168.15.7 -n 5 > c:\temp\log\ping7.log
echo getting network info 192.168.15.8 ...
ping 192.168.15.8 -n 5 > c:\temp\log\ping8.log
echo getting network info 192.168.15.9 ...
ping 192.168.15.9 -n 10 > c:\temp\log\ping9.log
echo getting network info 192.168.15.10 ...
ping 192.168.15.10 -n 10 > c:\temp\log\ping10.log
