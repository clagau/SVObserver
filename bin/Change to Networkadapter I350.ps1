...
$changeOEMInfo = Switch-ModelNo "52"
Remove-Item $OemInfoIniPath -Force
New-IniContent  $changeOEMInfo | Out-File -FilePath $OemInfoIniPath

Remove-NetIPAddress -InterfaceAlias "GigE_Port_001" -Confirm:$false
New-NetIPAddress -InterfaceAlias "GigE_Port_001" -AddressFamily IPv4 -IPAddress 192.168.101.1 -PrefixLength 24
Restart-NetAdapter -Name "GigE_Port_001"

Remove-NetIPAddress -InterfaceAlias "GigE_Port_002" -Confirm:$false
New-NetIPAddress -InterfaceAlias "GigE_Port_002" -AddressFamily IPv4 -IPAddress 192.168.102.1 -PrefixLength 24
Restart-NetAdapter -Name "GigE_Port_002"

Remove-NetIPAddress -InterfaceAlias "GigE_Port_003" -Confirm:$false
New-NetIPAddress -InterfaceAlias "GigE_Port_003" -AddressFamily IPv4 -IPAddress 192.168.103.1 -PrefixLength 24
Restart-NetAdapter -Name "GigE_Port_003"

Remove-NetIPAddress -InterfaceAlias "GigE_Port_004" -Confirm:$false
New-NetIPAddress -InterfaceAlias "GigE_Port_004" -AddressFamily IPv4 -IPAddress 192.168.104.1 -PrefixLength 24
Restart-NetAdapter -Name "GigE_Port_004"
