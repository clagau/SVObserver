================================================================================
    MICROSOFT FOUNDATION CLASS-BIBLIOTHEK: TriggerRecordControllerTest-Projektübersicht
===============================================================================

Diese TriggerRecordControllerTest-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt. Diese Anwendung zeigt nicht nur die Grundlagen der Verwendung von Microsoft Foundation Classes, sondern dient auch als Ausgangspunkt für das Schreiben Ihrer Anwendung.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre TriggerRecordControllerTest-Anwendung besteht.

TriggerRecordControllerTest.vcxproj
...
TriggerRecordControllerTest.vcxproj.filters
...
TriggerRecordControllerTest.h
    Dies ist die Hauptheaderdatei für die Anwendung.
    Sie enthält andere projektspezifische Header (einschließlich Resource.h) und deklariert die CTriggerRecordControllerTestApp-Anwendungsklasse.

TriggerRecordControllerTest.cpp
    Dies ist die wichtigste Anwendungsquelldatei, die die Anwendungsklasse CTriggerRecordControllerTestApp enthält.

TriggerRecordControllerTest.rc
...
res\TriggerRecordControllerTest.ico
    Dies ist eine Symboldatei, die als Anwendungssymbol verwendet wird. Dieses Symbol ist in der Hauptressourcendatei TriggerRecordControllerTest.rc enthalten.

res\TriggerRecordControllerTest.rc2
...
TriggerRecordControllerTestDlg.h, TriggerRecordControllerTestDlg.cpp - das Dialogfeld
    Diese Dateien enthalten Ihre CTriggerRecordControllerTestDlg-Klasse. Diese Klasse definiert das Verhalten des Hauptdialogfelds der Anwendung. Die Vorlage für das Dialogfeld befindet sich in TriggerRecordControllerTest.rc und kann in Microsoft Visual C++ bearbeitet werden.
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen TriggerRecordControllerTest.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
...
TriggerRecordControllerTest.manifest
