 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.22   29 Apr 2013 12:58:50   jspila
 * Project:  SVObserver
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.0   22 Apr 2013 12:50:32   bWalter
 * Project:  SVObserver
 * Change Request (SCR) nbr:  814
 * SCR Title:  Upgrade SVObserver to Compile Using Visual Studio 2010
 * Checked in by:  bWalter;  Ben Walter
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.21   15 Aug 2012 14:27:26   jspila
 * Project:  SVObserver
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.20   31 Jul 2012 11:54:00   tbair
 * Project:  SVObserver
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.0   31 Jul 2012 11:50:54   tbair
 * Project:  SVObserver
 * Change Request (SCR) nbr:  776
 * SCR Title:  Modify SVIOTest to use the same parameters as SVObserver
 * Checked in by:  tBair;  Tom Bair
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.19   28 Apr 2011 10:04:16   tbair
 * Project:  SVObserver
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.18   15 Dec 2009 12:22:10   jspila
 * Project:  SVObserver
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.17   16 Oct 2009 12:10:36   jspila
 * Project:  SVObserver
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.16   22 May 2009 14:38:50   tbair
 * Project:  SVObserver
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.15   03 Oct 2008 17:37:48   sjones
 * Project:  SVObserver
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.14   11 Sep 2008 08:25:10   sjones
 * Project:  SVObserver
 * Change Request (SCR) nbr:  612
 * SCR Title:  Implement a timer trigger object
 * Checked in by:  sJones;  Steve Jones
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.13   17 Mar 2008 15:27:30   tbair
 * Project:  SVObserver
 * Change Request (SCR) nbr:  618
 * SCR Title:  Change IO Test App to work with new X3 hardware
 * Checked in by:  tBair;  Tom Bair
 * Change Description:  
 *   Changed un-used inputs for testIO app when the product type is an X3 from 0 and 1 to 6 and 7.
 * 
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.12   20 Jun 2007 13:09:42   Joe
 * Project:  SVObserver
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.11   23 Mar 2007 11:44:32   tbair
 * Project:  SVObserver
 * Change Request (SCR) nbr:  592
 * SCR Title:  Add  X3 product type to SVObserver
 * Checked in by:  tBair;  Tom Bair
 * Change Description:  
 *   Made all fan status available for a IO board type of 12 X3 Product.
 * 
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.10   06 Feb 2007 13:25:36   tbair
 * Project:  SVObserver
 * Change Request (SCR) nbr:  590
 * SCR Title:  Modify SVObserver to send the IO Board type to the parallel board
 * Checked in by:  tBair;  Tom Bair
 * Change Description:  
 *   Modified OnInitDialog to allow the trigger setup dialog to be displayed when testing a National Instruments board.
 * 
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.9   24 Jan 2007 12:01:22   tbair
 * Project:  SVObserver
 * Change Request (SCR) nbr:  590
 * SCR Title:  Modify SVObserver to send the IO Board type to the parallel board
 * Checked in by:  tBair;  Tom Bair
 * Change Description:  
 *   Removed unused ID in OnInitDialog
 * 
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.8   23 Jan 2007 16:14:00   tbair
 * Project:  SVObserver
 * Change Request (SCR) nbr:  590
 * SCR Title:  Modify SVObserver to send the IO Board type to the parallel board
 * Checked in by:  tBair;  Tom Bair
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.7   27 Jun 2006 09:31:12   tbair
 * Project:  SVObserver
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.6   20 Mar 2006 15:00:56   tbair
 * Project:  SVObserver
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.5   15 Mar 2006 13:58:12   tbair
 * Project:  SVObserver
 * Change Request (SCR) nbr:  545
 * SCR Title:  Display version information for rabbit board component
 * Checked in by:  tBair;  Tom Bair
 * Change Description:  
 *   Changed VARIANT to COleVariant to simplify initialization.
 * 
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.4   15 Mar 2006 10:48:38   tbair
 * Project:  SVObserver
 * Change Request (SCR) nbr:  545
 * SCR Title:  Display version information for rabbit board component
 * Checked in by:  tBair;  Tom Bair
 * Change Description:  
 *   Added code to sample app to read the IO board version and display it in the io test applications window title.
 * 
 * Also added code to randomly test outputs with a static channel.  This helped the production dept. find bugs in I/O hardware.
 * 
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.3   17 Oct 2003 13:00:34   Joe
 * Project:  SVObserver
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.1   26 Aug 2003 15:24:04   Joe
 * Project:  SVObserver
 * Change Request (SCR) nbr:  322
 * SCR Title:  Add Additional Digital IO Resources to SVObserver
 * Checked in by:  rYoho;  Rob Yoho
 * Change Description:  
 *   Updated callback function to fix issues with min and max times.
 * 
 * /////////////////////////////////////////////////////////////////////////////////////
*/
