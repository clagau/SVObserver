...
{
	RegisterEmbeddedObject(&m_outputOperator, SvPb::ArithmeticOperatorEId, IDS_OBJECTNAME_ARITHMETICOPERATOR, false, SvOi::SVResetItemToolAndDependent, true);
	...
	RegisterEmbeddedObject(&m_IsGainOffsetEnabled, SvPb::ImageToolEnabledGainId, IDS_OBJECTNAME_IMAGETOOL_ENABLE_GAIN, false, SvOi::SVResetItemToolAndDependent, true);
	m_IsGainOffsetEnabled.SetDefaultValue(FALSE);

	RegisterEmbeddedObject(&m_UseLut, SvPb::ImageToolRecalculateOnceId, IDS_OBJECTNAME_RECALCULATE_ONCE, false, SvOi::SVResetItemToolAndDependent, true);
	m_UseLut.SetDefaultValue(FALSE);

	RegisterEmbeddedObject(&m_LinkedGain, SvPb::ImageToolGainId, IDS_OBJECTNAME_IMAGETOOL_GAIN, false, SvOi::SVResetItemToolAndDependent, true);

	m_LinkedGain.SetDefaultValue(_variant_t(1.0), true);
	
	RegisterEmbeddedObject(&m_LinkedOffset, SvPb::ImageToolOffsetId, IDS_OBJECTNAME_IMAGETOOL_OFFSET, false, SvOi::SVResetItemToolAndDependent, true);
...
SvPb::SVExtentLocationPropertyEnum SVImageToolClass::getLocationPropertyAtPoint(const SVPoint<double>& rPoint) const
{
