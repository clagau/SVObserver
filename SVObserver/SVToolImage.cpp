...
//* .Check In Date   : $Date:   13 Aug 2013 10:44:20  $
//******************************************************************************
...
BOOL SVImageToolClass::SetDefaultFormulas()
{
	...
	SVLUTEquationClass* pLUTEquation = ( SVLUTEquationClass* ) ::SVSendMessage( this, SVM_GETFIRST_OBJECT, NULL, ( DWORD ) &lutEquationInfo );
	if( pLUTEquation )
	{
