...
class SVCustomFilterClass;

/////////////////////////////////////////////////////////////////////////////
// SVCustomFilterDlg dialog

class SVCustomFilterDlg : public CDialog, public SVTaskObjectInterfaceClass
{
	// Construction
public:
	SVCustomFilterDlg();   // standard constructor
	
	SVCustomFilterClass *GetCustomFilter();
