...
BOOL SVDlgGraphClass::SetPoints( const SVObjectByteArrayClass& RByteVec ) 
{
...
BOOL SVDlgGraphClass::SetPoints( const SVObjectLongArrayClass& RLongVec ) 
{
...
BOOL SVDlgGraphClass::SetPoints( const SVObjectDoubleArrayClass& RDoubleVec ) 
{
...
BOOL SVDlgGraphClass::SetPoints( const SVObjectCPointArrayClass& RPointVec ) 
{
