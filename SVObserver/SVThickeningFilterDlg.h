...
class SVThickeningFilterClass;

/////////////////////////////////////////////////////////////////////////////
// SVThickeningFilterDlg dialog

class SVThickeningFilterDlg : public CDialog, public SVTaskObjectInterfaceClass
{
	// Construction
public:
	SVThickeningFilterDlg();   // standard constructor
	
	SVThickeningFilterClass *GetThickeningFilter();
