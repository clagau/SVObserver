...
////////////////////////////////////////////////////////////////////////////////
BOOL SVSharpenFilterClass::onRun( BOOL First, SVSmartHandlePointer RInputImageHandle, SVSmartHandlePointer ROutputImageHandle, SVRunStatusClass& RRunStatus )
{ 
...
//******************************************************************************
/*
$Log:   N:\PVCSarch65\ProjectFiles\archives\SVObserver_SRC\SVObserver\SVSharpenFilterClass.cpp_v  $
 * 
 *    Rev 1.0   09 Aug 2013 12:03:14   bwalter
 * Project:  SVObserver
