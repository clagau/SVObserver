...
//* .Check In Date   : $Date:   23 Apr 2013 14:55:26  $
//******************************************************************************
...
DWORD SVResultClass::processMessage( DWORD DwMessageID, DWORD DwMessageValue, DWORD DwMessageContext )
{
	DWORD DwResult = NULL;
...
SVRangeClass* SVResultClass::GetResultRange()
{
	...
	SVRangeClass* pRange = ( SVRangeClass* )SVSendMessage( this, SVM_GETFIRST_OBJECT, NULL, ( DWORD )&info );
	return pRange;
}
