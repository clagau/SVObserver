...
//* .File Name       : $Workfile:   SVLineMaximumObjectAnalyzer.cpp  $
//* ----------------------------------------------------------------------------
...
SVMaximumObjectLineAnalyzerClass::SVMaximumObjectLineAnalyzerClass( BOOL BCreateDefaultTaskList, SVObjectClass* POwner, int StringResourceID )
...
void SVMaximumObjectLineAnalyzerClass::init()
{
	// Identify our type
	outObjectInfo.ObjectTypeInfo.SubType = SVLineMaximumObjectAnalyzerObjectType;
	...
	//
	RegisterEmbeddedObject( &StrEdgeControlParameters9, SVEdgeParameters9ObjectGuid, IDS_OBJECTNAME_EDGE_PARAMETERS9, false, SVResetItemNone );
	RegisterEmbeddedObject( &StrEdgeControlParameters10, SVEdgeParameters10ObjectGuid, IDS_OBJECTNAME_EDGE_PARAMETERS10, false, SVResetItemNone );
	...
	//
	StrEdgeControlParameters9.ObjectAttributesAllowedRef() = SV_EMBEDABLE;
	StrEdgeControlParameters9.SetDefaultValue( _T( "" ), FALSE );

	StrEdgeControlParameters10.ObjectAttributesAllowedRef() = SV_EMBEDABLE;
	StrEdgeControlParameters10.SetDefaultValue( _T( "" ), FALSE );
}


SVMaximumObjectLineAnalyzerClass::~SVMaximumObjectLineAnalyzerClass()
{
	CloseObject();
}


BOOL SVMaximumObjectLineAnalyzerClass::CreateObject( SVObjectLevelCreateStruct* PCreateStructure )
{
	BOOL bOk = FALSE;
	CString csTemp9;
	CString csTemp10;
	...
	if( bOk = SVDualLineAnalyzerClass::CreateObject( PCreateStructure ) )
	{
		...
		//
		StrEdgeControlParameters9.GetValue(csTemp9);
		edgeAControl.ConvertStringToParams((LPCTSTR)csTemp9);

		StrEdgeControlParameters10.GetValue(csTemp10);
		edgeBControl.ConvertStringToParams((LPCTSTR)csTemp10);
	}
	...
	if( ! csTemp9.IsEmpty() )
	{
		...
		StrEdgeControlParameters9.SetValue( 1L, _T( "" ) );
	}
	...
	if( ! csTemp10.IsEmpty() )
	{
		...
		StrEdgeControlParameters10.SetValue( 1L, _T( "" ) );
	}
	...
	StrEdgeControlParameters9.ObjectAttributesAllowedRef() &= ~SV_PRINTABLE;
	StrEdgeControlParameters10.ObjectAttributesAllowedRef() &= ~SV_PRINTABLE;
...
BOOL SVMaximumObjectLineAnalyzerClass::CloseObject()
{
	return SVDualLineAnalyzerClass::CloseObject();
}

BOOL SVMaximumObjectLineAnalyzerClass::onRun( SVRunStatusClass& RRunStatus )
{
	...
	if( SVDualLineAnalyzerClass::onRun( RRunStatus ) )
	{
		  ...
		  )
		{
			...
			// Preset maximum foreground object...
			...
			for( int indexB = 0; indexB < rEdgeBList.GetSize() && indexB + offsetA < rEdgeAList.GetSize(); ++ indexB )
			{
				// Throw lower positive edges away...
				while( rEdgeBList.GetAt( indexB ) >= rEdgeAList.GetAt( indexB + offsetA ) &&
					   indexB + ( ++offsetA ) < rEdgeAList.GetSize() );

				// Check for indexA bounds...
				if( indexB + offsetA >= rEdgeAList.GetSize() )
					break;

				if( rEdgeAList.GetAt( indexB + offsetA ) - rEdgeBList.GetAt( indexB ) > dwMaxBackgroundDistance )
				{
					dwMaxBackgroundDistance = rEdgeAList.GetAt( indexB + offsetA ) - rEdgeBList.GetAt( indexB );
					
					resultAIndex = indexB + offsetA;
					resultBIndex = indexB;
				}
			}

			// Set maximum object...
			if( dwMaxBackgroundDistance > dwMaxForegroundDistance )
			{
				// Set current marker positions on the Line...
				lEdgeA = ( resultBIndex >= 0 ) ? rEdgeBList.GetAt( resultBIndex ) : -1;
				lEdgeB = ( resultAIndex >= 0 ) ? rEdgeAList.GetAt( resultAIndex ) : -1;
			}
...
////////////////////////////////////////////////////////////////////////////////
BOOL SVMaximumObjectLineAnalyzerClass::OnValidate()
{
	BOOL retVal = FALSE;
...
//******************************************************************************
/*
$Log:   N:\PVCSarch65\ProjectFiles\archives\SVObserver_src\SVObserver\SVLineMaximumObjectAnalyzer.cpp_v  $
 * 
 *    Rev 1.0   23 Apr 2013 12:09:26   bWalter
 * Project:  SVObserver
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 3.31   16 Aug 2012 18:55:54   jspila
 * Project:  SVObserver
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 3.30   18 Jul 2012 13:42:56   jspila
 * Project:  SVObserver
 * Change Request (SCR) nbr:  769
 * SCR Title:  Fix Problems and Crashes with Inspection Document Display Updates
 * Checked in by:  Joe;  Joe Spila
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 3.29   16 Jul 2012 12:56:12   jspila
 * Project:  SVObserver
 * Change Request (SCR) nbr:  769
 * SCR Title:  Fix Problems and Crashes with Inspection Document Display Updates
 * Checked in by:  Joe;  Joe Spila
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 3.28   10 Jul 2012 12:19:00   jspila
 * Project:  SVObserver
 * Change Request (SCR) nbr:  769
 * SCR Title:  Fix Problems and Crashes with Inspection Document Display Updates
 * Checked in by:  Joe;  Joe Spila
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 3.27   02 Jul 2012 17:17:58   jspila
 * Project:  SVObserver
 * Change Request (SCR) nbr:  769
 * SCR Title:  Fix Problems and Crashes with Inspection Document Display Updates
 * Checked in by:  Joe;  Joe Spila
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 3.26   30 Mar 2011 15:13:36   jspila
 * Project:  SVObserver
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 3.25   08 Dec 2010 13:02:32   jspila
 * Project:  SVObserver
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 3.24   01 Jun 2010 14:52:18   jspila
 * Project:  SVObserver
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 3.23   16 Dec 2009 14:03:44   jspila
 * Project:  SVObserver
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 3.22   21 Jun 2007 13:28:52   Joe
 * Project:  SVObserver
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 3.21   14 Oct 2005 11:27:44   Joe
 * Project:  SVObserver
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 3.19   12 Aug 2005 13:50:00   Joe
 * Project:  SVObserver
 * Change Request (SCR) nbr:  500
 * SCR Title:  Reduce delay when adjusting tool parameters with a large toolset
 * Checked in by:  Joe;  Joe Spila
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 3.16   17 Feb 2005 14:40:20   Joe
 * Project:  SVObserver
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 3.15   09 Dec 2003 12:20:06   rschock
 * Project:  SVObserver
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 3.14   04 Dec 2003 13:04:06   rschock
 * Project:  SVObserver
 * Change Request (SCR) nbr:  385
 * SCR Title:  Expose additional parameters for SIAC
 * Checked in by:  rYoho;  Rob Yoho
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 3.13   18 Nov 2003 14:05:06   ryoho
 * Project:  SVObserver
 * Change Request (SCR) nbr:  385
 * SCR Title:  Expose additional parameters for SIAC
 * Checked in by:  rYoho;  Rob Yoho
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 3.11   08 Oct 2003 11:05:32   ryoho
 * Project:  SVObserver
 * Change Request (SCR) nbr:  385
 * SCR Title:  Expose additional parameters for SIAC
 * Checked in by:  rYoho;  Rob Yoho
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 3.10   22 Apr 2003 10:48:48   rschock
 * Project:  SVObserver
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 3.9   30 Jan 2003 12:07:46   joe
 * Project:  SVObserver
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 3.8   10 Jan 2003 15:32:46   rschock
 * Project:  SVObserver
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 3.7   09 Dec 2002 19:33:00   Joe
 * Project:  SVObserver
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 3.6   19 Nov 2002 15:18:50   ryoho
 * Project:  SVObserver
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 3.3   03 Mar 2000 12:19:30   sjones
 * Project:  SVObserver
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 3.2   21 Feb 2000 14:45:24   sjones
 * Project:  SVObserver
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.10   11 Nov 1999 11:13:26   sjones
 * Project:  SVObserver
 * Change Request (SCR) nbr:  21
 * SCR Title:  Port Gage Tool code from program version 2.42.
 * Checked in by:  Nick;  F Roland "Nick" Bjorklund
 * Change Description:  
 *   Revised onRun to correctly find maximum object
 * 
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.9   Oct 04 1999 10:27:04   Nick
 * Project:  SVObserver
 * Change Request (SCR) nbr:  21
 * SCR Title:  Port Gage Tool code from program version 2.42.
 * Checked in by:  Nick;  F Roland "Nick" Bjorklund
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.8   Sep 30 1999 13:51:14   Nick
 * Project:  SVObserver
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.6   13 Sep 1999 13:48:22   sjones
 * Project:  SVObserver
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.5   Sep 10 1999 19:02:02   Nick
 * Project:  SVObserver
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.3   31 Aug 1999 10:49:14   robert
 * Project:  SVObserver
 * Change Request (SCR) nbr:  21
 * SCR Title:  Port Gage Tool code from program version 2.42.
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.2   31 Aug 1999 09:50:38   sjones
 * Project:  SVObserver
 * Change Request (SCR) nbr:  9
 * SCR Title:  Integr. a common object interface to handle and to identify obj. in-/outputs
 * Checked in by:  sJones;  Steve Jones
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.1   30 Aug 1999 14:43:46   robert
 * Project:  SVObserver
 * Change Request (SCR) nbr:  21
 * SCR Title:  Port Gage Tool code from program version 2.42.
 * Checked in by:  Robert;  Robert Massinger
