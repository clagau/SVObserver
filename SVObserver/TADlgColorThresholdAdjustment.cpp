...
//* .File Name       : $Workfile:   TADlgColorThresholdAdjustment.cpp  $
//* ----------------------------------------------------------------------------
...
IMPLEMENT_DYNCREATE(TADlgColorThresholdAdjustment, TADlgColorThresholdBasePage)

BEGIN_MESSAGE_MAP(TADlgColorThresholdAdjustment, TADlgColorThresholdBasePage)
	//{{AFX_MSG_MAP(TADlgColorThresholdAdjustment)
...
TADlgColorThresholdAdjustment::TADlgColorThresholdAdjustment() 
: TADlgColorThresholdBasePage(TADlgColorThresholdAdjustment::IDD)
//InspectionID and TaskID are set later
, m_Values {SvOgu::BoundValues{ SvDef::InvalidObjectId, SvDef::InvalidObjectId }}
{
	//{{AFX_DATA_INIT(TADlgColorThresholdAdjustment)
	StrUpper = _T("");
	StrLower = _T("");
	m_exclude = FALSE;
	//}}AFX_DATA_INIT
...
void TADlgColorThresholdAdjustment::SetInspectionData()
{
...
void TADlgColorThresholdAdjustment::DoDataExchange(CDataExchange* pDX)
{
	TADlgColorThresholdBasePage::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(TADlgColorThresholdAdjustment)
...
/////////////////////////////////////////////////////////////////////////////
// TADlgColorThresholdAdjustment message handlers

BOOL TADlgColorThresholdAdjustment::OnInitDialog() 
{
...
void TADlgColorThresholdAdjustment::setThresholdParams()
{
	SetInspectionData();
}

void TADlgColorThresholdAdjustment::updateControls()
{
...
void TADlgColorThresholdAdjustment::setInitialValues()
{
...
void TADlgColorThresholdAdjustment::setScrollRange( CSliderCtrl* pSliderCtrl, int min, int max )
{
	// Revise the scale ?
...
void TADlgColorThresholdAdjustment::setScrollPos( CSliderCtrl* pSliderCtrl, int pos )
{
...
void TADlgColorThresholdAdjustment::updateGraphDisplay()
{
	if( nullptr != m_pTool )
	{
...
void TADlgColorThresholdAdjustment::OnExcludeColorThreshold()
{
	UpdateData();
	setThresholdParams();
...
void TADlgColorThresholdAdjustment::OnEnabledThreshold()
{
	UpdateData();
	setThresholdParams();
...
void TADlgColorThresholdAdjustment::OnVScroll(UINT nSBCode, UINT nPos, CScrollBar* pScrollBar) 
{
	...
	else if( &LowerSliderCtrl == reinterpret_cast<CSliderCtrl*> (pScrollBar))
	{
	...
	TADlgColorThresholdBasePage::OnVScroll(nSBCode, nPos, pScrollBar);
}

BOOL TADlgColorThresholdAdjustment::OnSetActive() 
{
	updateGraphDisplay();	
	return TADlgColorThresholdBasePage::OnSetActive();
}

void TADlgColorThresholdAdjustment::OnMouseMove(UINT nFlags, CPoint point) 
{
...
void TADlgColorThresholdAdjustment::RefreshProperties()
{
	m_pSheet->m_rectROI = m_pSheet->m_pFigureEditor->GetRect();
}

bool TADlgColorThresholdAdjustment::initHistogram()
{
	bool result{false};
...
void TADlgColorThresholdAdjustment::updateHistogram()
{
...
void TADlgColorThresholdAdjustment::updateThresholdBars()
{
	if(nullptr != m_pThreshold)
	{
