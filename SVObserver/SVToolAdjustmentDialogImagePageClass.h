...
class SVToolAdjustmentDialogImagePageClass : public CPropertyPage, public SVTaskObjectInterfaceClass
{
public:
	SVToolAdjustmentDialogImagePageClass( SVToolAdjustmentDialogSheetClass* Parent, int id = IDD );

	~SVToolAdjustmentDialogImagePageClass();
...
protected:
	...
	SVImageClass*						pCurrentSourceImage;
	SVInObjectInfoStruct*				pImageInputInfo;
	int									oldIndex;
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.1   16 Dec 2009 13:20:12   jspila
 * Project:  SVObserver
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.0   09 Aug 2005 08:37:06   Joe
 * Project:  SVObserver
