...
// * .Check In Date   : $Date:   23 Apr 2013 11:59:50  $
// ******************************************************************************
...
{
	// Identify our type
	outObjectInfo.ObjectTypeInfo.SubType = SVLinearMaximumForegroundObjectAnalyzerObjectType;
	...
	if( l_bOk )
	{
		...
		for( int indexA = 0; indexA < l_iACount && indexA + offsetB < l_iBCount; ++ indexA )
		{
			...
			while( l_svAEdges.at( indexA ) >= l_svBEdges.at( indexA + offsetB ) &&
					 indexA + ( ++offsetB ) < static_cast<int>(l_svBEdges.size()) );

			// Check for indexB bounds...
			if( indexA + offsetB >= static_cast<int>(l_svBEdges.size()) )
				break;
...
BOOL SVLinearMaximumForegroundObjectLineAnalyzerClass::OnValidate()
{
	BOOL retVal = FALSE;
...
// ******************************************************************************
/*
$Log:   N:\PVCSarch65\ProjectFiles\archives\SVObserver_src\SVObserver\SVLinearLineMaximumForegroundObjectAnalyzer.cpp_v  $
 * 
 *    Rev 1.0   23 Apr 2013 11:59:50   bWalter
 * Project:  SVObserver
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.14   01 Aug 2012 12:56:44   jspila
 * Project:  SVObserver
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.13   27 Jan 2011 11:28:04   jspila
 * Project:  SVObserver
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.12   08 Dec 2010 12:56:40   jspila
 * Project:  SVObserver
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.11   01 Jun 2010 14:44:36   jspila
 * Project:  SVObserver
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.10   16 Dec 2009 11:28:40   jspila
 * Project:  SVObserver
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.9   21 Jun 2007 13:27:42   Joe
 * Project:  SVObserver
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.8   12 Aug 2005 13:11:14   ebeyeler
 * Project:  SVObserver
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.7   01 Aug 2005 12:00:10   ebeyeler
 * Project:  SVObserver
 * Change Request (SCR) nbr:  464
 * SCR Title:  Add array indexing for value objects
 * Checked in by:  eBeyeler;  Eric Beyeler
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.6   29 Jul 2005 12:39:52   Joe
 * Project:  SVObserver
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.5   21 Jun 2005 08:11:50   ebeyeler
 * Project:  SVObserver
 * Change Request (SCR) nbr:  464
 * SCR Title:  Add array indexing for value objects
 * Checked in by:  eBeyeler;  Eric Beyeler
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.4   22 Mar 2005 07:52:36   ryoho
 * Project:  SVObserver
