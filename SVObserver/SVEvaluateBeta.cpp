...
//* .Check In Date   : $Date:   15 May 2014 11:21:40  $
//******************************************************************************
...
SV_IMPLEMENT_CLASS( SVEvaluateBetaClass, SVEvaluateBetaClassGuid )

SVEvaluateBetaClass::SVEvaluateBetaClass( SVObjectClass* POwner, int StringResourceID )
				    :SVMathContainerClass( POwner, StringResourceID ) 
{
	// Identify yourself
	outObjectInfo.ObjectTypeInfo.SubType = SVEvaluateBetaObjectType;

	// Identify our input type needs...

	// Register Embedded Objects
	RegisterEmbeddedObject( &outputMathEnabled, SVOutputEvaluateBetaEnabledObjectGuid, IDS_OBJECTNAME_ENABLED, false, SVResetItemNone );
	RegisterEmbeddedObject( &outputMathResult, SVOutputEvaluateBetaResultObjectGuid, IDS_OBJECTNAME_RESULT, false, SVResetItemNone );
...
SVEvaluateBetaClass::~SVEvaluateBetaClass()
{
	CloseObject();
}

BOOL SVEvaluateBetaClass::CreateObject( SVObjectLevelCreateStruct* PCreateStructure )
{
...
BOOL SVEvaluateBetaClass::CloseObject()
{
...
SVBoolValueObjectClass*	SVEvaluateBetaClass::getOutputMathEnabled()
{
	return &outputMathEnabled;
}

SVDoubleValueObjectClass* SVEvaluateBetaClass::getOutputMathResult()
{
	return &outputMathResult;
}

BOOL SVEvaluateBetaClass::onRun( SVRunStatusClass& RRunStatus )
{
...
DWORD_PTR SVEvaluateBetaClass::processMessage( DWORD DwMessageID, DWORD_PTR DwMessageValue, DWORD_PTR DwMessageContext )
{
 ...
 * 
 *    Rev 1.2   15 May 2014 11:21:40   sjones
 * Project:  SVObserver
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 3.9   16 Dec 2009 10:21:42   jspila
 * Project:  SVObserver
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 3.4   22 Apr 2003 09:25:46   rschock
 * Project:  SVObserver
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 3.2   09 Dec 2002 19:19:24   Joe
 * Project:  SVObserver
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 3.0   23 Nov 1999 11:29:44   mike
 * Project:  SVObserver
