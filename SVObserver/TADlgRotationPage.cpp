...
//* .File Name       : $Workfile:   TADlgRotationPage.cpp  $
//* ----------------------------------------------------------------------------
...
BEGIN_MESSAGE_MAP(TADlgRotationPage, CPropertyPage)
	//{{AFX_MSG_MAP(TADlgRotationPage)
...
TADlgRotationPage::TADlgRotationPage( uint32_t inspectionId, uint32_t taskObjectId)
: CPropertyPage(TADlgRotationPage::IDD)
...
TADlgRotationPage::~TADlgRotationPage()
{
}

#pragma region Protected Methods
#pragma region MFC Methods
void TADlgRotationPage::DoDataExchange(CDataExchange* pDX)
{
	CPropertyPage::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(TADlgRotationPage)
...
BOOL TADlgRotationPage::OnSetActive()
{
...
/////////////////////////////////////////////////////////////////////////////
// TADlgRotationPage message handlers
BOOL TADlgRotationPage::OnInitDialog() 
{
...
void TADlgRotationPage::OnAngleFormulaButton() 
{
...
void TADlgRotationPage::OnXFormulaButton() 
{
...
void TADlgRotationPage::OnYFormulaButton() 
{
...
void TADlgRotationPage::OnPerformRotation() 
{
	refresh();
}

void TADlgRotationPage::OnSelChangeInterpolationModeCombo() 
{
	SetInspectionData();
}
#pragma endregion MFC Methods

void TADlgRotationPage::SetInspectionData()
{
...
void TADlgRotationPage::refresh()
{
	SetInspectionData();
