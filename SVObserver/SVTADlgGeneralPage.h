...
/////////////////////////////////////////////////////////////////////////////
// SVToolAdjustmentDialogGeneralPageClass dialog

class SVToolAdjustmentDialogGeneralPageClass : public CPropertyPage, public SVTaskObjectInterfaceClass
{
//******************************************************************************
// Constructor(s):
//******************************************************************************
public:
	SVToolAdjustmentDialogGeneralPageClass( SVToolAdjustmentDialogSheetClass* PSheet );
...
public:
	...
	SVAvailableSourceImageListComboBoxClass	m_AvailableSourceImageCombo;
	SVEnumerateComboClass	drawToolCombo;
	BOOL	m_bUpdateAuxilliaryExtents;
	//}}AFX_DATA
...
protected:
	...
	// Tool's Draw Flag...
	SVEnumerateValueObjectClass*		pToolDrawFlag;
	SVBoolValueObjectClass*             m_pUpdateAuxilliary;
	bool                                m_bIsImageTool;
	SVImageListClass				    m_aImageList;
	// AuxInputInfo
