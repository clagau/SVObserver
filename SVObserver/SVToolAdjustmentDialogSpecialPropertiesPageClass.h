...
//* .File Name       : $Workfile:   SVToolAdjustmentDialogSpecialPropertiesPageClass.h  $
//* ----------------------------------------------------------------------------
//* .Current Version : $Revision:   1.0  $
//* .Check In Date   : $Date:   23 Apr 2013 15:40:44  $
//******************************************************************************
...
#ifndef _SVTOOLADJUSTMENTDIALOGSPECIALPROPERTIESPAGECLASS_H
#define _SVTOOLADJUSTMENTDIALOGSPECIALPROPERTIESPAGECLASS_H
...
////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////
// Dialogfeld SVToolAdjustmentDialogSpecialPropertiesPageClass 

class SVToolAdjustmentDialogSpecialPropertiesPageClass : public CPropertyPage, public SVTaskObjectInterfaceClass
{

// Konstruktion
public:
	SVToolAdjustmentDialogSpecialPropertiesPageClass( SVToolAdjustmentDialogSheetClass* PParent );

	~SVToolAdjustmentDialogSpecialPropertiesPageClass();

	virtual HRESULT SetInspectionData();

	//{{AFX_DATA(SVToolAdjustmentDialogSpecialPropertiesPageClass)
	enum { IDD = IDD_TA_SPECIAL_TOOL_PROPERTIES_DIALOG };
	//}}AFX_DATA

protected:
	SVToolAdjustmentDialogSheetClass*	pParentDialog;
	SVToolPropertyEntryStruct*			pPropertyArray;
	SVToolPropertyEntryStruct*			pOriginalPropertyArray;
	int propertyCount;

	HRESULT ReflectAngularProfileToolProperty( int PropertyID, DWORD PropertyValue );
	HRESULT ReflectProfileToolProperty( int PropertyID, DWORD PropertyValue );

	//{{AFX_VIRTUAL(SVToolAdjustmentDialogSpecialPropertiesPageClass)
	protected:
...
// Implementierung
protected:
	void checkCkeck( int ID );

	//{{AFX_MSG(SVToolAdjustmentDialogSpecialPropertiesPageClass)
...
#endif // _SVTOOLADJUSTMENTDIALOGSPECIALPROPERTIESPAGECLASS_H

//******************************************************************************
//* LOG HISTORY:
//******************************************************************************
/*
$Log:   N:\PVCSarch65\ProjectFiles\archives\SVObserver_src\SVObserver\SVToolAdjustmentDialogSpecialPropertiesPageClass.h_v  $
 * 
 *    Rev 1.0   23 Apr 2013 15:40:44   bWalter
 * Project:  SVObserver
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.0   09 Aug 2005 08:37:32   Joe
 * Project:  SVObserver
