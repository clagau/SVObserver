...
public:
	...
	virtual bool GetImageHandle( SVImageBufferHandlePtr& p_rHandlePtr ) override;
	virtual bool GetImageHandle( SVImageIndexStruct svIndex, SVImageBufferHandlePtr& rHandle ) override;
