...
public:
	...
	DoubleSortValuePtr addNewColumn(LPCTSTR name, const SVTaskObjectClass* pAnalyzer);
	...
	DoubleSortValuePtr setNewColumn(const SVObjectClass* pColumn, const SVTaskObjectClass* pAnalyzer);
