...
//* .File Name       : $Workfile:   TADlgExternalInputSelectPage.h  $
//* ----------------------------------------------------------------------------
...
class TADlgExternalInputSelectPage : public CPropertyPage
{
	//DECLARE_DYNCREATE(TADlgExternalInputSelectPage)

// Construction
public:
	TADlgExternalInputSelectPage(LPCTSTR Title, uint32_t inspectionID, uint32_t toolObjectID, SvOgu::ExternalToolTaskController& rExternalToolTaskController);
	virtual ~TADlgExternalInputSelectPage() = default;

	// Dialog Data
	//{{AFX_DATA(TADlgExternalInputSelectPage)
...
// Overrides
	...
	//{{AFX_VIRTUAL(TADlgExternalInputSelectPage)
	public:
...
protected:
	...
	//{{AFX_MSG(TADlgExternalInputSelectPage)
