...
//* .Check In Date   : $Date:   23 Apr 2013 09:53:58  $
//******************************************************************************
		...
		if( pImage )
		{
		  ...
		  if( !histResultID.empty() )
		  {
			  ...
			  try
			  {
				  ...
				  ::SVSendMessage( this, SVM_CREATE_CHILD_OBJECT, (DWORD)&band0HistogramImage, NULL );
				  ::SVSendMessage( this, SVM_CREATE_CHILD_OBJECT, (DWORD)&band1HistogramImage, NULL );
				  ::SVSendMessage( this, SVM_CREATE_CHILD_OBJECT, (DWORD)&band2HistogramImage, NULL );
			  }
			  catch(...)
			  {
			  }
