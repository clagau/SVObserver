...
//* .File Name       : $Workfile:   TADlgMaskPageClass.h  $
//* ----------------------------------------------------------------------------
...
class TADlgMaskPageClass : public CPropertyPage
{
public:
	TADlgMaskPageClass(uint32_t inspectionId, uint32_t taskObjectId, uint32_t maskOperatorId);
	virtual ~TADlgMaskPageClass();
...
private:
	...
	static TADlgMaskPageClass* m_pThis;
