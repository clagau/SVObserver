...
void SVOIPDocClass::Serialize(CArchive& ar)
{
	...
	Exception.setMessage( E_NOTIMPL, SvStl::Tid_ErrorUsedPreviouslyForSec, SvStl::SourceFileParams(StdMessageParams), SvStl::Err_15035 );
}
...
void SVOIPDocClass::SetPathName( LPCTSTR lpszPathName, BOOL bAddToMRU ) 
{
	...
	COleServerDoc::SetPathName( msvFileName.GetFullFileName().c_str(), FALSE );
}
