...
#pragma region Public Methods
	...
	//************************************
	template <typename ELEMENT_TYPE>
	BasicValueObjectPtr setValueObject( LPCTSTR DottedName, const ELEMENT_TYPE Value, SVObjectClass* pOwner = nullptr, SVObjectTypeEnum ObjectType = SVBasicValueObjectType );
...
private:
	...
	//************************************
	template <typename ELEMENT_TYPE>
	vt_const_iterator createValueObject( LPCTSTR DottedName, const ELEMENT_TYPE Value, SVObjectClass* pOwner, SVObjectTypeEnum ObjectType );
