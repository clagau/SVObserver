...
//* .Check In Date   : $Date:   13 May 2013 12:16:10  $
//******************************************************************************
...
BOOL SVImagePolarTransformClass::SetDefaultFormulas()
{
	...
	SVEvaluateCenterXClass* pEvaluateCenterX = ( SVEvaluateCenterXClass* ) ::SVSendMessage( GetTool(), SVM_GETFIRST_OBJECT, NULL, ( DWORD ) &objectInfo );
	if( pEvaluateCenterX )
	{
		// Find equation object...
		SVEquationClass* pEquation = ( SVEquationClass* ) ::SVSendMessage( pEvaluateCenterX, SVM_GETFIRST_OBJECT, NULL, ( DWORD ) &equationObjectInfo );
		if( pEquation )
		{
	...
	SVEvaluateCenterYClass* pEvaluateCenterY = ( SVEvaluateCenterYClass* ) ::SVSendMessage( GetTool(), SVM_GETFIRST_OBJECT, NULL, ( DWORD ) &objectInfo );
	if( pEvaluateCenterY )
	{
		// Find equation object...
		SVEquationClass* pEquation = ( SVEquationClass* ) ::SVSendMessage( pEvaluateCenterY, SVM_GETFIRST_OBJECT, NULL, ( DWORD ) &equationObjectInfo );
		if( pEquation )
		{
	...
	SVEvaluateStartRadiusClass* pEvaluateStartRadius = ( SVEvaluateStartRadiusClass* ) ::SVSendMessage( GetTool(), SVM_GETFIRST_OBJECT, NULL, ( DWORD ) &objectInfo );
	if( pEvaluateStartRadius )
	{
		// Find equation object...
		SVEquationClass* pEquation = ( SVEquationClass* ) ::SVSendMessage( pEvaluateStartRadius, SVM_GETFIRST_OBJECT, NULL, ( DWORD ) &equationObjectInfo );
		if( pEquation )
		{
	...
	SVEvaluateEndRadiusClass* pEvaluateEndRadius = ( SVEvaluateEndRadiusClass* ) ::SVSendMessage( GetTool(), SVM_GETFIRST_OBJECT, NULL, ( DWORD ) &objectInfo );
	if( pEvaluateEndRadius )
	{
		// Find equation object...
		SVEquationClass* pEquation = ( SVEquationClass* ) ::SVSendMessage( pEvaluateEndRadius, SVM_GETFIRST_OBJECT, NULL, ( DWORD ) &equationObjectInfo );
		if( pEquation )
		{
	...
	SVEvaluateStartAngleClass* pEvaluateStartAngle = ( SVEvaluateStartAngleClass* ) ::SVSendMessage( GetTool(), SVM_GETFIRST_OBJECT, NULL, ( DWORD ) &objectInfo );
	if( pEvaluateStartAngle )
	{
		// Find equation object...
		SVEquationClass* pEquation = ( SVEquationClass* ) ::SVSendMessage( pEvaluateStartAngle, SVM_GETFIRST_OBJECT, NULL, ( DWORD ) &equationObjectInfo );
		if( pEquation )
		{
	...
	SVEvaluateEndAngleClass* pEvaluateEndAngle = ( SVEvaluateEndAngleClass* ) ::SVSendMessage( GetTool(), SVM_GETFIRST_OBJECT, NULL, ( DWORD ) &objectInfo );
	if( pEvaluateEndAngle )
	{
		// Find equation object...
		SVEquationClass* pEquation = ( SVEquationClass* ) ::SVSendMessage( pEvaluateEndAngle, SVM_GETFIRST_OBJECT, NULL, ( DWORD ) &equationObjectInfo );
		if( pEquation )
		{
...
DWORD SVImagePolarTransformClass::processMessage( DWORD DwMessageID, DWORD DwMessageValue, DWORD DwMessageContext )
{
	DWORD DwResult = NULL;
