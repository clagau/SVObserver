...
public:
	...
	//************************************
	void setImageFromParent( SVImageClass* pImage, long tabNumber = 0 );
	...
	// Access:    public
	// Returns:   void
	// Parameter: SVImageClass* pImage: The object-pointer of the image which will be set.
	// Parameter: long tabNumber = 0: The tab number of the activeX-control.
	//************************************
	void setImage( SVImageClass* pImage, long tabNumber = 0 );
	...
	// Access:    public
	// Returns:   void
	// Parameter: SVSmartHandlePointer imageHandle: The handle of the image which will be set.
	// Parameter: long tabNumber = 0: The tab number of the activeX-control.
	//************************************
	void setImage( SVSmartHandlePointer imageHandle, long tabNumber = 0 );
