...
class SVThinningFilterClass;

/////////////////////////////////////////////////////////////////////////////
// SVThinningFilterDlg dialog

class SVThinningFilterDlg : public CDialog, public SVTaskObjectInterfaceClass
{
	// Construction
public:
	SVThinningFilterDlg();   // standard constructor
	
	SVThinningFilterClass *GetThinningFilter();
