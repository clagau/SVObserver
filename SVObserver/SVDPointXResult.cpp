					...
					:SVResultClass( POwner, StringResourceID )
{
	...
	m_outObjectInfo.m_ObjectTypeInfo.SubType = SvDef::SVResultDPointXObjectType;
...
bool SVDPointXResultClass::CreateObject( const SVObjectLevelCreateStruct& rCreateStructure )
{
	...
	x.SetObjectAttributesAllowed( SvDef::SV_PRINTABLE, SvOi::SetAttributeType::RemoveAttribute );
