...
namespace Seidenader { namespace SVObserver
{
	...
	const TCHAR* const   Error_OMD_FontNotWitExt = _T( "Font File Requires '.Wit' Extension: %s" );
	...
	const TCHAR* const   Error_OGD_ScaleValueToLow = _T("Minimum Scale Value must be greater then 0.0099");
	...
	const TCHAR* const   CorecoAcq_UnableToLoad = _T("Unable to load cca/cvi files");
	...
	const TCHAR* const   FastOCR_functionAddressNotFound = _T("Unable to find the function address for %s");
	const TCHAR* const   FastOCR_LoadDllFailed = _T("Invalid Data""Unable to load DLL %s");
	...
	const TCHAR* const   OCRAnalyzer_DLLLoadFailed = _T("Failed to Load OCR Library");
	const TCHAR* const   OCRAnalyzer_Unsupported = _T("OCR OCV Analyzer is not supported on this platform. The tool will become invalid.");
	...
	const TCHAR* const   Error_MilPitchAndWidthError = _T("Mil image Pitch and Width Error");
	const TCHAR* const   Error_OCRDataConvertFailed = _T("OCR data convert failed");
	const TCHAR* const   Error_OCRDataFormatingFailed = _T("OCR data formating failed");
	const TCHAR* const   OCR_NoToolSpecified = _T("Font Training Setup: No TOOL specified");
	const TCHAR* const   OCR_NoOperatorListSpecified = _T("Font Training Setup: No OperatorList specified");
	const TCHAR* const   OCR_NoImageSpecified = _T("Font Training Setup: No Image specified");
	const TCHAR* const   OCR_FontTrainFailedToStart = _T("Font Training Failed to Start");
	const TCHAR* const   OCRGrayAnalyzer_DLLLoadFailed = _T("Failed to Load OCR Gray Library");
	const TCHAR* const   OCRGrayAnalyzer_Unsupported = _T("OCR OCV Gray Scale Analyzer is not supported on this platform. The tool will become invalid.");
