...
public:
	...
	virtual SvStl::MessageContainerVector validateAndSetEmmeddedValues(const SvOi::SetValuePairVector& rValueVector, bool shouldSet) override;
...
private:
	...
	bool getNewUseDontCareValue(const SvOi::SetValuePairVector &rValueVector);
	...
	bool validateNewDontCareFileName(const SvOi::SetValuePairVector &rValueVector, long& rDontCareWidth, long& rDontCareHeight, SvStl::MessageContainerVector& rMessages);
	...
	/// \param rMessages [out] Vector of errors.
	/// \returns bool True if the value should be set and the image should reloaded from file.
	bool validateNewModelFileName(const SvOi::SetValuePairVector &rValueVector, long& rModelWidth, long& rModelHeight, SvStl::MessageContainerVector &messages);
