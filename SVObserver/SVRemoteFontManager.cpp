...
#include "SVMatroxLibrary/SVMatroxOcrCreateStruct.h"
...
bool SVRemoteFontManager::GetFontCharImage( long p_lFontIdentifier, SVMatroxOcr p_FontHandle, long p_lID, SVMatroxBuffer& p_CharHandle )
{
	...
	ImageInfo.SetExtentProperty(SvPb::SVExtentPropertyWidth, dCharBoxSizeX );
	ImageInfo.SetExtentProperty(SvPb::SVExtentPropertyHeight, dCharBoxSizeY );
