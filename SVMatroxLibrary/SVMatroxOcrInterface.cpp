...
HRESULT SVMatroxOcrInterface::RestoreFont( const SVCommandDataHolder& p_rAttributes, SVCommandDataHolder& p_rResults )
{
	...
	if( p_rAttributes.GetBlock( _T( "Control File Contents" ), l_ControlFileContents ) == S_OK )
	{
		l_Status = ConvertByteVectorToTempFile( l_ControlFileContents, l_ControlFileName );
	}

	if( p_rAttributes.GetBlock( _T( "Constraint File Contents" ), l_ConstraintFileContents ) == S_OK )
	{
	...
	if( l_Status == S_OK )
	{
		...
		if( l_Status == S_OK && 0 < l_ControlFileName.size() )
		{
			l_Status = RestoreFont( lFontHandle, l_ControlFileName, SVOcrLoadControl );
		}

		if( l_Status == S_OK && 0 < l_ConstraintFileName.size() )
		{
...
HRESULT SVMatroxOcrInterface::FindFontCharacters( const SVCommandDataHolder& p_rAttributes, SVCommandDataHolder& p_rResults )
{
	...
	SVCommandDataContainer* l_pBlobResults = NULL;
		...
		if( l_Blobs.size() > 0 )
		{
			...
			for( size_t x = 0 ; x < l_Blobs.size() ; x++ )
			{
					...
					&& (l_rBlob.boundingRect.right - l_rBlob.boundingRect.left)>3)
				{
					...
					long l_tmp;
					if( ThicknessCalculation( ROIBuf, l_BackgroundType, l_tmp ) == S_OK)
					{
...
HRESULT SVMatroxOcrInterface::CreateFontIdFromFontData( const SVCommandDataHolder& p_rFontData, SVMatroxOcr& p_rFontId )
{
	...
	if( l_Status == S_OK )
	{
		...
		if( l_Status != S_OK && !( p_rFontId.empty() ) )
		{
			Destroy( p_rFontId );
		}
	}
...
HRESULT SVMatroxOcrInterface::UpdateCharacterListFromFontId( const SVMatroxOcr& p_rFontId, SVCommandDataHolder& p_rFontData )
{
	...
	for ( size_t i = 0; l_Status == S_OK && i < l_strFontChars.size(); ++i )
	{
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.11   16 Aug 2012 16:44:16   jspila
 * Project:  SVObserver
 * Change Request (SCR) nbr:  771
 * SCR Title:  Upgrade to the Next Version of Matrox Imaging Library (MIL)
 * Checked in by:  Joe;  Joe Spila
 * Change Description:  
 *   Updated OCR Interface to fix a problem with the resource tracking fucntionality.
 * 
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.10   16 Sep 2011 14:29:44   jspila
 * Project:  SVObserver
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.9   28 Apr 2011 08:57:50   tbair
 * Project:  SVObserver
 * Change Request (SCR) nbr:  701
 * SCR Title:  Add New Font Functionality to the Existing Command Interface
 * Checked in by:  tBair;  Tom Bair
 * Change Description:  
 *   Added properties to CreateFontDataFromFontId and CreateFontIdFromFontData
 * 
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.8   11 Mar 2011 13:36:28   jspila
 * Project:  SVObserver
 * Change Request (SCR) nbr:  701
 * SCR Title:  Add New Font Functionality to the Existing Command Interface
 * Checked in by:  Joe;  Joe Spila
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.7   27 Jan 2011 10:39:02   jspila
 * Project:  SVObserver
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.6   11 Jan 2011 12:56:48   jspila
 * Project:  SVObserver
 * Change Request (SCR) nbr:  701
 * SCR Title:  Add New Font Functionality to the Existing Command Interface
 * Checked in by:  Joe;  Joe Spila
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.5   15 Oct 2010 15:00:36   jspila
 * Project:  SVObserver
 * Change Request (SCR) nbr:  701
 * SCR Title:  Add New Font Functionality to the Existing Command Interface
 * Checked in by:  Joe;  Joe Spila
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.4   18 Nov 2008 11:07:58   tbair
 * Project:  SVObserver
 * Change Request (SCR) nbr:  632
 * SCR Title:  Fix bug in Remote Font Manager
 * Checked in by:  tBair;  Tom Bair
 * Change Description:  
 *   Removed const on the SVMatroxString Parameter in the CopyFont function.
 * 
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.3   17 Nov 2008 14:42:26   tbair
 * Project:  SVObserver
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.2   14 Nov 2008 14:27:40   jbrown
 * Project:  SVObserver
 * Change Request (SCR) nbr:  641
 * SCR Title:  BoundsChecker results
 * Checked in by:  JimAdmin;  James A. Brown
 * Change Description:  
 *   Added support for M_PREPROCESSED within
 * SVMatroxOcrInterface::Convert2MatroxControlType ().
 * 
 * 
 * 
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.1   30 Jul 2008 07:24:10   tbair
 * Project:  SVObserver
 * Change Request (SCR) nbr:  632
 * SCR Title:  Fix bug in Remote Font Manager
 * Checked in by:  tBair;  Tom Bair
