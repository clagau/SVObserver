...
void SVAutoThresholdEquation::init()
{
	...
	m_ObjectTypeInfo.m_SubType	= SvPb::SVAutoThresholdEquationObjectType;
...
bool SVAutoThresholdEquation::onRun( SvIe::RunStatus& rRunStatus, SvStl::MessageContainerVector *pErrorMessages )
{
	double Value = 0.0;
