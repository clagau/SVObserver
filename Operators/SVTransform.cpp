				 ...
				 :SVTaskObjectClass( POwner, StringResourceID ) 
{
	...
	RegisterEmbeddedObject( &m_performTranslation, SvPb::PerformTranslationEId, IDS_OBJECTNAME_PERFORM_TRANSLATION, false, SvOi::SVResetItemToolAndDependent, true);
	RegisterEmbeddedObject( &m_performRotation, SvPb::PerformRotationEId, IDS_OBJECTNAME_PERFORM_ROTATION, false, SvOi::SVResetItemToolAndDependent, true);

	RegisterEmbeddedObject( &m_learnedTranslationX, SvPb::LearnedTranslationXEId, IDS_OBJECTNAME_LEARNED_TRANSLATION_X, false, SvOi::SVResetItemToolAndDependent, true);
	RegisterEmbeddedObject( &m_learnedTranslationY, SvPb::LearnedTranslationYEId, IDS_OBJECTNAME_LEARNED_TRANSLATION_Y, false, SvOi::SVResetItemToolAndDependent, true);
	RegisterEmbeddedObject( &m_learnedRotationX, SvPb::LearnedRotationXEId, IDS_OBJECTNAME_LEARNED_ROTATION_X, false, SvOi::SVResetItemToolAndDependent, true);
	RegisterEmbeddedObject( &m_learnedRotationY, SvPb::LearnedRotationYEId, IDS_OBJECTNAME_LEARNED_ROTATION_Y, false, SvOi::SVResetItemToolAndDependent, true);
	RegisterEmbeddedObject( &m_learnedRotationAngle, SvPb::LearnedRotationAngleEId, IDS_OBJECTNAME_LEARNED_ROTATION_ANGLE, false, SvOi::SVResetItemToolAndDependent, true);
