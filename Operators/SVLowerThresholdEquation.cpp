...
void SVLowerThresholdEquation::init()
{
	...
	m_ObjectTypeInfo.m_SubType	= SvPb::SVLowerThresholdEquationObjectType;
	...
	RegisterEmbeddedObject( &result, SvPb::LowerThresholdEquationResultEId, IDS_OBJECTNAME_LOWER_THRESHOLD_RESULT, false, SvOi::SVResetItemNone, false);
...
bool SVLowerThresholdEquation::onRun( SvIe::RunStatus& rRunStatus, SvStl::MessageContainerVector *pErrorMessages )
{
	double value = 0.0;
