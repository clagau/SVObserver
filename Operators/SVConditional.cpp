...
void SVConditional::init()
{
	...
	m_outObjectInfo.m_ObjectTypeInfo.m_SubType = SvPb::SVConditionalObjectType;
...
bool SVConditional::onRun( RunStatus& rRunStatus, SvStl::MessageContainerVector *pErrorMessages )
{
	BOOL Value = false;
