...
public: 
	...
	double m_AcquisitionStartTime;	///< time stamp at which the image acquisition is started (first packet received) 
	double m_AcquisitionTime;		///< time required for the complete image acquisition
