...
MessageTextMap g_MessageTextMap = boost::assign::map_list_of
	...
	(SvOi::Tid_Pattern_DontCare2Small, _T("The dont care image is to small. It must have at least the size of the model."))
	...
	(SvOi::Tid_DontCareInvalidFilename, _T("Not a Valid Dont Care file"))
	(SvOi::Tid_DontCareImage_LoadFailed, _T("Load of dont care iamge failed."))
