...
MessageTextMap g_MessageTextMap = boost::assign::map_list_of
	...
	(SvOi::Tid_ArchiveTool_PathEmpty, _T("Archive Path is empty"))
	(SvOi::Tid_ArchiveTool_CreateFileFailed, _T("Create Archive File \"%s\" Failed"))
	(SvOi::Tid_ArchiveTool_CreatePathFailed, _T("Create Archive Path \"%s\" Failed"))
	(SvOi::Tid_ArchiveTool_WriteToFileFailed, _T("Write to Archive File failed"))
	(SvOi::Tid_ArchiveTool_AllocImageFailed, _T("Allocate Image Buffer failed: %s"))
	...
	(SvOi::Tid_SVObserver_MatroxLicenseNotFound, _T("Matrox License not found"))
	...
	(SvOi::Tid_Error_MilImageTypeInvalid, _T("MIL Image Type Not 8 Bit Unsigned: %s"))
	...
	(SvOi::Tid_Pattern_Model2Large, _T("Model is larger than the ROI of the Window Tool."))
	(SvOi::Tid_Pattern_DontCare2Small, _T("The don't care image is to small. It must have at least the size of the model."))
	(SvOi::Tid_Pattern_Invalid_ShouldLeave, _T("Pattern Model is invalid. Do you want to change Model (Yes) or leave dialog (No)?"))
	...
	(SvOi::Tid_DontCareInvalidFilename, _T("Not a Valid Don't Care file"))
	(SvOi::Tid_DontCareImage_LoadFailed, _T("Load of don't care image failed."))
	(SvOi::Tid_PatAllocModelFailed, _T("Pattern Model Allocation Failed."))
	(SvOi::Tid_PatAllocFailed, _T("Pattern image Allocation Failed."))
	...
	(SvOi::Tid_ConnectInputFailed, _T("Connect Input failed."))
	...
	(SvOi::Tid_CreateChildBufferFailed, _T("Create Child Buffer failed"))
	(SvOi::Tid_CreateImageHandleArrayFailed, _T("Create ImageHandle-Array failed"))
	(SvOi::Tid_NoSourceImage, _T("Could not retrieve the source image."))
	(SvOi::Tid_MilBarCodeInitFailed, _T("Mil Bar code initilized failed."))
	(SvOi::Tid_BarCodeMatchStringLoadFailed, _T("Load of the match string for the Bar code result failed."))
	(SvOi::Tid_UpdateOutputImageExtentsFailed, _T("Update Output image extents failed."))
	(SvOi::Tid_InitExternalTaskFailed, _T("Initialized of External Taks failed."))
	(SvOi::Tid_InitImageFailed, _T("Initialized of Image failed."))
	(SvOi::Tid_UpdateTransformDataFailed, _T("Updating transform data failed."))
	(SvOi::Tid_UpdateLineExtentDataFailed, _T("Updating Line extent data failed."))
	(SvOi::Tid_UpdateLinearToolDataFailed, _T("Updating Linear tool data failed."))
	(SvOi::Tid_UpdateBufferFailed, _T("Update buffer failed."))
	(SvOi::Tid_UpdateTranslationFailed, _T("Update translation failed."))
	(SvOi::Tid_InvalidModuleReadyPointer, _T("Invalid module ready pointer."))
	(SvOi::Tid_InvalidRaidBitPointer, _T("Invalid raid bit pointer."))
	(SvOi::Tid_IoController_RebuildOutpuListFailed, _T("IOController: Rebuild Output list failed."))
	(SvOi::Tid_GetPixelDepthFailed, _T("Get Pixel Depth failed."))
	(SvOi::Tid_GetImageExtentFailed, _T("Get Image Extent failed."))
	(SvOi::Tid_SetImageExtentFailed, _T("Set Image Extent failed."))
	(SvOi::Tid_GetEdgeAFailed, _T("Get Edge A failed."))
	(SvOi::Tid_GetEdgeBFailed, _T("Get Edge B failed."))
	(SvOi::Tid_Pattern_ResetImageFileFailed, _T("Pattern match: Reset image file failed."))
	(SvOi::Tid_Pattern_SetCenterFailed, _T("Pattern match: Set Center failed."))
	(SvOi::Tid_Pattern_GetModelImageNameFailed, _T("Pattern match: Get model image name failed."))
	(SvOi::Tid_Pattern_SetSearchParamFailed, _T("Pattern match: Set search parameter failed."))
	(SvOi::Tid_CreateLutFailed, _T("Create LUT failed."))
	(SvOi::Tid_StatToolTestFailed, _T("Statistic Tool test failed."))
	(SvOi::Tid_RebuildFailed, _T("Rebuild failed."))
	(SvOi::Tid_InvalidOwner, _T("Invalid Owner."))
	(SvOi::Tid_WrongType, _T("Wrong type."))
	(SvOi::Tid_InvalidLinkedObjectOrSame, _T("Invalid Linked Object or itself."))
	(SvOi::Tid_WrongInspection, _T("Object is not from the same Inspection."))
	(SvOi::Tid_NoShapeHelper, _T("No shape helper found."))
	(SvOi::Tid_NoCameraToMainImage, _T("No camera to main image found."))
	(SvOi::Tid_NotImageTypePhysical, _T("The image type must be physical."))
	(SvOi::Tid_NotCreated, _T("The Object is not created."))
	(SvOi::Tid_ToolsetNotCreated, _T("The Toolset was not created."))
	(SvOi::Tid_SetImageHandleIndexFailed, _T("SetImageHandleIndex failed."))
	(SvOi::Tid_CopyImagesFailed, _T("Copy of images failed."))
	(SvOi::Tid_RunFilterFailed, _T("Run filter failed."))
	(SvOi::Tid_RunWarpFailed, _T("Run warp failed."))
	(SvOi::Tid_RunRotateFailed, _T("Run Rotate failed."))
	(SvOi::Tid_RunArithmeticFailed, _T("Run Arithmetic failed."))
	(SvOi::Tid_LockingFailed, _T("Locking failed."))
	(SvOi::Tid_ExternalTask_CheckToRunFailed, _T("External task: check if runable failed."))
	(SvOi::Tid_ExternalTask_UnknownException, _T("External task: Unknown exception. %s"))
	(SvOi::Tid_BinarizeFailed, _T("Binarize failed."))
	(SvOi::Tid_SetValueFailed, _T("Setting of value failed."))
	(SvOi::Tid_RunImagePolarFailed, _T("Prepare of run image polar transformation failed."))
	(SvOi::Tid_UnknownException, _T("Unknown exception."))
	(SvOi::Tid_EmptyValueList, _T("Empty value list."))
	(SvOi::Tid_InvalidRange, _T("Invalid range"))
	(SvOi::Tid_RunLinearEdgeFailed, _T("Runing of linear edge processing failed."))
	(SvOi::Tid_RunLinearEdgeFailed, _T("Runing of linear edge processing failed."))
	(SvOi::Tid_ProcessCommandQueueFailed, _T("ProcessCommandQueue failed."))
