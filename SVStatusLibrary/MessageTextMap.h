...
namespace SvStl
{
	...
	MessageTextMap cMessageTextMap
	{
		...
		{Tid_ToolsZipFailed, _T("Failed to zip tool data.")},
		{Tid_ToolsUnzipFailed, _T("Failed to unzip tool data.")},
		...
		{Tid_CloseConfigFailed , _T("Close config failed")},
		...
		{Tid_PlcOutputsDeleted, _T("The following PLC outputs for {0} have been deleted due to being invalid. Check that all outputs are corretly set\r\n{1}")},
