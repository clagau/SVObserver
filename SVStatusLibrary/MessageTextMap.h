...
namespace SvStl
{
	...
	MessageTextMap cMessageTextMap
	{
		...
		{Tid_RunTool_Exception, _T("SVRunTool: Exception %s raised by '%s'")},
		{Tid_SVInitializeRun_Exception, _T("SVInitializeRun: Exception %s raised by '%s'")},
		...
		{Tid_FileCamera_NoImageFile, _T("FileAcquisition::No Image File to Load, possible Invalid or Empty Directory %s")},
		{Tid_FileCamera_LoadFailed, _T("FileAcquisition::Unable to Load Image File %s")},
		{Tid_FileAcquisition_FormatError, _T("FileAcquisition::CopyImage - Error in Format")},
		{Tid_CameraEndFrame_GetNextBufferFailed, _T("CameraEndFrame(%s): GetNextBuffer failed")},
		...
		{Tid_ExternalDllPassesTheTest, _T("External DLL passes the test%s.") },
		...
		{Tid_TRC_Error_NoBufferFree, _T("New image buffer for struct %s failed: No buffer free.")},
		...
		{Tid_TRC_Error_GetTRData, _T("GetTrData failed: Pos = %s, TRNumber = %s.")},
		...
		{Tid_InvalidInputType, _T("The %s (%s) type is invalid.") },
		{Tid_InvalidInputValue, _T("The %s (%s) value is invalid.") },
		{Tid_InvalidInputObject, _T("The %s (%s) value is not %s.")},
