...
namespace SvStl
{
	...
	(Tid_RegressionTest_NoFileSelected, _T("Selection Error: \"Use single file\" is selected for one of the cameras but a file was not selected. Select again?"))
	(Tid_RegressionTest_WrongFormat, _T("Selection Error: \"Use list of files\" selected, but the file name does not match\n the acceptable format (<file name>_<sequence number>.bmp). Select again?"))
	(Tid_RegressionTest_NoFilesSelected, _T("Selection Error:  \"No files\" selected.  Select again?"))
	(Tid_RegressionTest_FileNotExist, _T("Selection Error:  File does not exist.  Select again?"))
