...
enum MessageTextEnum
{
	...
	Tid_ArchiveTool_NotEnoughImageBuffer,
	...
	Tid_FileName_Exists,
	Tid_MaxImagesForArchiveToolTooHigh,
	Tid_NotEnoughArchiveImageMemory,
	Tid_NotEnoughArchiveImageMemoryPleaseDeselect,
