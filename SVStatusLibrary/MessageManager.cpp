...
void MessageManagerHelper::LogError(LPCSTR errortext, const SvStl::SourceFileParams& rFileParams, Severity  sev)
{
	...
	switch (sev)
	{
		...
		case Severity::Assert:
			MesMan.setMessage(SVMSG_SVO_114_ASSERT_CONDITION_FAILED, SvStl::Tid_Default, msgList, rFileParams);
			break;
