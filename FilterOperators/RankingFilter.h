...
private:
	...
	SvVol::SVLongValueObjectClass *m_plvoRankingCells[cellSize];

	SvVol::SVLongValueObjectClass m_lvoRankingWidth;
	SvVol::SVLongValueObjectClass m_lvoRankingHeight;
	SvVol::SVLongValueObjectClass m_lvoRankingRank;
};
