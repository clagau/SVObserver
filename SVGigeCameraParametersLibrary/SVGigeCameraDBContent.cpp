...
typedef std::map<WString,  StringList> AttributesMap;
static AttributesMap Attributes = boost::assign::map_list_of<>
	( L"SVGigeParameter",				( boost::assign::list_of<WString>
											(L"SVGigeParameterEnum")
										)
	)
	( L"SVGigeDeviceParameterStruct",	( boost::assign::list_of<WString>
											(L"DeviceParameterName")
											(L"DeviceParameterType")
										)
	)
	( L"SVGigeFeature",					( boost::assign::list_of<WString>
											(L"FeatureName")
											(L"FeatureType")
											(L"FeatureSupportedEnum")
											(L"FeatureAccessEnum")
										)
	)
	( L"SVGigeAccessor",				( boost::assign::list_of<WString>
											(L"Getter")
											(L"Setter")
										)
	)
	( L"SVGigeFeatureSelector",			( boost::assign::list_of<WString>
											(L"SelectorName")
											(L"SelectorValue")
										)
	)
	( L"SVGigeFeatureStringEnum",		( boost::assign::list_of<WString>
											(L"SVDeviceParamString")
											(L"SVGigeFeatureString")
										)
	)
;
...
//******************************************************************************
/*
$Log:   N:\PVCSarch65\ProjectFiles\archives\SVObserver_src\SVGigeCameraParametersLibrary\SVGigeCameraDBContent.cpp_v  $
 * 
 *    Rev 1.2   15 May 2013 19:36:48   bWalter
 * Project:  SVObserver
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.5   10 May 2013 10:07:44   sjones
 * Project:  SVObserver
 * Change Request (SCR) nbr:  828
 * SCR Title:  Camera Binning
 * Checked in by:  sJones;  Steve Jones
 * Change Description:  
 *   Added SVGigeParameterVerticalBinning and SVGigeParameterHorizontalBinning
 * 
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.1   09 May 2013 15:56:50   bWalter
 * Project:  SVObserver
 * Change Request (SCR) nbr:  814
 * SCR Title:  Upgrade SVObserver to Compile Using Visual Studio 2010
 * Checked in by:  bWalter;  Ben Walter
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.4   01 May 2013 10:30:14   sjones
 * Project:  SVObserver
 * Change Request (SCR) nbr:  820
 * SCR Title:  Baumer Camera Trigger Debounce
 * Checked in by:  sJones;  Steve Jones
 * Change Description:  
 *   Revised ConstructGigeParameterAccessor method to allow string enum lists with or without selectors
 * 
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.0   22 Apr 2013 09:46:14   bWalter
 * Project:  SVObserver
 * Change Request (SCR) nbr:  814
 * SCR Title:  Upgrade SVObserver to Compile Using Visual Studio 2010
 * Checked in by:  bWalter;  Ben Walter
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.3   01 Apr 2013 15:52:14   sjones
 * Project:  SVObserver
 * Change Request (SCR) nbr:  820
 * SCR Title:  Baumer Camera Trigger Debounce
 * Checked in by:  sJones;  Steve Jones
 * Change Description:  
 *   Added strings for custom Gige device parameters
 * 
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.2   18 Jan 2013 15:51:30   sjones
 * Project:  SVObserver
