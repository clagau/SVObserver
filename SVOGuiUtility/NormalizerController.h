...
//******************************************************************************
	...
	public:
		...
		//************************************
		NormalizerController::NormalizerValues getValues();
		//************************************
		// Method: setRanges()
		...
		// Returns:  bool true if the call succeeded, false otherwise (e.g. InspectionCommand call fails).
		//************************************
		NormalizerController::NormalizerValues setRanges(double realMin, double realMax, double realStep, double normalMin, double normalMax, double normalStep);
		//************************************
