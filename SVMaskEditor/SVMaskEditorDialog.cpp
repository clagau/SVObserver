...
void SVMaskEditorDialogClass::zoom( int ZoomOperand )
{
    ...
    if( !curDisplayBuf.empty() )
    {
        ...
        StrZoom.Format( _T( "Zoom X/Y: %d/%d" ), currentZoomX, currentZoomY );
    }
}
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
      ...
      Rev 3.8   27 Jan 2011 10:14:02   jspila
   Project:  SVObserver
   ...
   /////////////////////////////////////////////////////////////////////////////////////
      ...
      Rev 3.7   06 Jun 2008 11:27:02   tbair
   Project:  SVObserver
   Change Request (SCR) nbr:  597
   SCR Title:  Upgrade Matrox Imaging Library to version 8.0
   Checked in by:  tBair;  Tom Bair
   Change Description:  
     Removed scalePoint for pan position because it is already in the correct scale.(dialog coordinates)
   
   /////////////////////////////////////////////////////////////////////////////////////
   
      Rev 3.6   04 Jun 2008 10:28:52   tbair
   Project:  SVObserver
   Change Request (SCR) nbr:  597
   SCR Title:  Upgrade Matrox Imaging Library to version 8.0
   Checked in by:  tBair;  Tom Bair
   Change Description:  
     Fixed bug in initDialog that made the scale wrong.
   
   /////////////////////////////////////////////////////////////////////////////////////
   
      Rev 3.5   29 May 2008 10:05:54   tbair
   Project:  SVObserver
   Change Request (SCR) nbr:  597
   SCR Title:  Upgrade Matrox Imaging Library to version 8.0
   Checked in by:  tBair;  Tom Bair
   Change Description:  
     Modified SVMatroxDisplayInterfaceGet parameters to be double instead of long so the zoom will work. With long parameters the wrong overload was called.
   
   /////////////////////////////////////////////////////////////////////////////////////
   
      Rev 3.4   24 Jul 2007 10:18:50   tbair
   Project:  SVObserver
   Change Request (SCR) nbr:  597
   SCR Title:  Upgrade Matrox Imaging Library to version 8.0
   Checked in by:  tBair;  Tom Bair
   ...
   /////////////////////////////////////////////////////////////////////////////////////
      ...
      Rev 3.3   18 Feb 2005 11:59:40   Joe
   Project:  SVObserver
   Change Request (SCR) nbr:  452
   SCR Title:  Upgrade SVObserver to version 4.50
   Checked in by:  rYoho;  Rob Yoho
   Change Description:  
     Removed redundent call to start matrox app manager.
   
   /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.0   Jan 03 2000 10:45:10   Nick
 * Project:  SVObserver
 * Change Request (SCR) nbr:  73
 * SCR Title:  Mask Editor Mil 5.0 to Mil 6.0 repairs.
 * Checked in by:  Nick;  F Roland "Nick" Bjorklund
 * Change Description:  
 *   Changes required when MIL 5.0 library was changed to MIL 6.0 library.  Masking operation required Windows HDC (device context) to be created for a Mil image buffer.   MIL 6.0 image buffers require the M_DIB (for Device Independent Bitmap) characteristic to specified for an image buffer that needs the HDC created i.e. masking operations.  Software was modified to add this M_DIB characteristic when a Windows HDC is required for MIL  image buffer.
 * 
 * /////////////////////////////////////////////////////////////////////////////////////
*/
