...
void TableLimitAnalyzer::BuildEmbeddedObjectList()
{
	...
	RegisterEmbeddedObject( &m_LimitValue, SvPb::TableAnaylzerLimitValueEId, IDS_OBJECTNAME_TABLEANALYZERLIMIT_VALUE, true, SvOi::SVResetItemToolAndDependent, true);
	_variant_t vtTemp;
	::VariantInit(&vtTemp);
