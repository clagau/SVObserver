...
namespace SvOg
{
	class TADlgDrawPage : public CPropertyPage
	{
	public:
		TADlgDrawPage(uint32_t inspectionId, uint32_t taskObjectId);
		virtual ~TADlgDrawPage();
	...
	private:
		...
		void setValueCtrlData(SvPb::EmbeddedIdEnum embeddedId, SvOgu::ValueController& rValueController, TADlgDrawPage::BOSAEnum ctrlEnum, int min, int max, const std::string& fieldName, bool readOnly = false);
		void ObjectChangedExDialogImage(long, long, VARIANT* ParameterList, VARIANT* ParameterValue);
		void setControl(TADlgDrawPage::BOSAEnum editEnum, TADlgDrawPage::BOSAEnum buttonEnum, SvPb::EmbeddedIdEnum embeddedId, SvOgu::TreeNodeData& rData, SvOgu::ValidCheckCallback validCallback = nullptr);
		void setControl(TADlgDrawPage::BOSAEnum staticEnum, LPCSTR staticText, TADlgDrawPage::BOSAEnum editEnum, TADlgDrawPage::BOSAEnum buttonEnum, SvPb::EmbeddedIdEnum embeddedId, SvOgu::TreeNodeData& rData, SvOgu::ValidCheckCallback validCallback = nullptr);
