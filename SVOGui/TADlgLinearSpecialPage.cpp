...
//* All Rights Reserved
//******************************************************************************
//* .Module Name     : TADlgLinearSpecialPage
//* .File Name       : $Workfile:   TADlgLinearSpecialPage.cpp  $
//* ----------------------------------------------------------------------------
...
#include "stdafx.h"
#include "TADlgLinearSpecialPage.h"
...
namespace SvOg
{
	BEGIN_MESSAGE_MAP(TADlgLinearSpecialPage, CPropertyPage)
	...
	TADlgLinearSpecialPage::TADlgLinearSpecialPage( uint32_t inspectionId, uint32_t taskObjectId)
	: CPropertyPage(TADlgLinearSpecialPage::IDD)
	...
	TADlgLinearSpecialPage::~TADlgLinearSpecialPage()
	{
	}

	HRESULT TADlgLinearSpecialPage::SetInspectionData()
	{
	...
	void TADlgLinearSpecialPage::DoDataExchange(CDataExchange* pDX)
	{
	...
	BOOL TADlgLinearSpecialPage::OnInitDialog() 
	{
	...
	void TADlgLinearSpecialPage::OnSelchangeComboProfileOrientation() 
	{
		SetInspectionData();
	}

	void TADlgLinearSpecialPage::OnCheckRotation() 
	{
