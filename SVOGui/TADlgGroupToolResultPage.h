...
/// \file TADlgGroupToolResultPage.h
...
namespace SvOg
{
	class TADlgGroupToolResultPage : public CPropertyPage, public ISVPropertyPageDialog
	{
...
#pragma region Protected Methods
		...
		//{{AFX_VIRTUAL(TADlgGroupToolResultPage)
	protected:
		virtual void DoDataExchange(CDataExchange* pDX) override;    // DDX/DDV-Unterstützung
																	 //}}AFX_VIRTUAL
	protected:
		//{{AFX_MSG(TADlgGroupToolResultPage)
