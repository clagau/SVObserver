...
namespace SvOg
{
	class TADlgTableSourcePage : public CPropertyPage//, protected ImageController
	{
...
#pragma region Constructor
	public:
		TADlgTableSourcePage(uint32_t inspectionId, uint32_t taskObjectId, int id = IDD);
		virtual ~TADlgTableSourcePage();
