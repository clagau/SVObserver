...
#include "stdafx.h"
#include "TADlgTableDefinesPage.h"
...
BEGIN_MESSAGE_MAP(TADlgTableDefinesPage, CPropertyPage)
	//{{AFX_MSG_MAP(TADlgTableDefinesPage)
...
TADlgTableDefinesPage::TADlgTableDefinesPage(uint32_t inspectionId, uint32_t taskObjectId)
	: CPropertyPage(TADlgTableDefinesPage::IDD)
	, m_InspectionID(inspectionId)
	, m_TaskObjectID(taskObjectId)
{
}

TADlgTableDefinesPage::~TADlgTableDefinesPage()
{
}
#pragma endregion Constructor

#pragma region Public Methods
bool TADlgTableDefinesPage::QueryAllowExit()
{
	ValidateData();
	return true;
}
...
void TADlgTableDefinesPage::DoDataExchange(CDataExchange* pDX)
{
	CPropertyPage::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(TADlgTableDefinesPage)
	DDX_Control(pDX, IDC_GRID, m_Grid);
	DDX_Text(pDX, IDC_EDIT_COMMENT, m_strComment);
	//}}AFX_DATA_MAP
}

BOOL TADlgTableDefinesPage::OnInitDialog()
{
...
BOOL TADlgTableDefinesPage::OnKillActive()
{
	ValidateData();
	return CPropertyPage::OnKillActive();
}

void TADlgTableDefinesPage::OnBnClickedButtonRemove()
{
...
void TADlgTableDefinesPage::OnBnClickedMoveUp()
{
	SvGcl::CellRange Selection = m_Grid.GetSelectedCellRange();
...
void TADlgTableDefinesPage::OnBnClickedMoveDown()
{
	SvGcl::CellRange Selection = m_Grid.GetSelectedCellRange();
...
void TADlgTableDefinesPage::OnKillFocusComment()
{
	SvGcl::CellRange Selection = m_Grid.GetSelectedCellRange();
...
void TADlgTableDefinesPage::OnBnClickedButtonAdd()
{
...
void TADlgTableDefinesPage::OnGridDblClick(NMHDR *pNotifyStruct, LRESULT* /*pResult*/)
{
...
void TADlgTableDefinesPage::OnGridRClick(NMHDR *, LRESULT* /*pResult*/)
{
	CPoint p;
	if (GetCursorPos(&p))
	{
...
void TADlgTableDefinesPage::OnGridEndEdit(NMHDR *pNotifyStruct, LRESULT* pResult)
{
	SvGcl::NM_GRIDVIEW* pItem = (SvGcl::NM_GRIDVIEW*) pNotifyStruct;
...
void TADlgTableDefinesPage::OnSelectionChanged(NMHDR*, LRESULT*)
{
	UpdateEnableButtons();
}
...
HRESULT TADlgTableDefinesPage::ValidateData()
{
	UpdateData(TRUE);
...
void TADlgTableDefinesPage::initGridControl()
{
...
void TADlgTableDefinesPage::FillGridControl()
{
	m_gridList.clear();
	SvPb::InspectionCmdRequest requestCmd;
	SvPb::InspectionCmdResponse responseCmd;
...
bool TADlgTableDefinesPage::isTableNameUnique(const std::string& name)
{
	bool bResult = true;
	for (int i = 0; i < m_gridList.size(); i++)
	{
...
void TADlgTableDefinesPage::showContextMenu(CPoint point)
{
	CMenu menu;
...
void TADlgTableDefinesPage::MoveColumn(uint32_t moveId, uint32_t preId)
{
	SvPb::InspectionCmdRequest requestCmd;
...
void TADlgTableDefinesPage::UpdateEnableButtons()
{
	SvGcl::CellRange Selection = m_Grid.GetSelectedCellRange();
...
HRESULT TADlgTableDefinesPage::AddColumn(const std::string& rName, uint32_t addPreId)
{
	SvPb::InspectionCmdRequest requestCmd;
