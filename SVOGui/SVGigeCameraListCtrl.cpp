	...
	namespace SVOGui
	{
		...
		void SVGigeCameraListCtrl::DrawItem(LPDRAWITEMSTRUCT lpDrawItemStruct) 
		{
			...
			if (iIndex > -1)
			{
				...
				{
					SvOi::SVGigeCameraStructInterface* pCamStruct = (SvOi::SVGigeCameraStructInterface *)lpDrawItemStruct->itemData;
					...
					if ( pCamStruct )
					{
						...
						{
						case SvOi::SVGigeCameraStructInterface::SVNoChange:
							{
						...
						case SvOi::SVGigeCameraStructInterface::SVNewCamera:
							{
						...
						case SvOi::SVGigeCameraStructInterface::SVReplacedCamera:
							{
						...
						case SvOi::SVGigeCameraStructInterface::SVCameraRemoved:
							{
