...
namespace SvOg
{
	class TADlgTableDefinesPage : public CPropertyPage, public ISVPropertyPageDialog
	{
#pragma region Declarations
	protected:
		//{{AFX_DATA(TADlgTableDefinesPage)
...
#pragma region Constructor
	public:
		...
		TADlgTableDefinesPage( uint32_t inspectionId, uint32_t taskObjectId );

		// Standard destructor
		virtual ~TADlgTableDefinesPage();
...
#pragma region Protected Methods
		...
		//{{AFX_VIRTUAL(TADlgTableDefinesPage)
	protected:
		virtual void DoDataExchange(CDataExchange* pDX) override;    // DDX/DDV-Unterstützung
		//}}AFX_VIRTUAL
	protected:
		//{{AFX_MSG(TADlgTableDefinesPage)
