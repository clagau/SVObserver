...
namespace SvOg
{
	...
	{
		UpdateData();
		m_data.m_type = static_cast<SvPb::LinkedSelectedType>(m_iType + 1);
	...
	{
		SvPb::LinkedSelectedType type = static_cast<SvPb::LinkedSelectedType>(m_iType + 1);
