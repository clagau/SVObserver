...
/// \file TADlgTableAnalyzerPage.cpp
/// All Rights Reserved 
//*****************************************************************************
...
#include "stdafx.h"
#include "TADlgTableAnalyzerPage.h"
...
BEGIN_MESSAGE_MAP(TADlgTableAnalyzerPage, CPropertyPage)
	//{{AFX_MSG_MAP(TADlgTableAnalyzerPage)
...
TADlgTableAnalyzerPage::TADlgTableAnalyzerPage(uint32_t inspectionId, uint32_t taskObjectId)
	: CPropertyPage(TADlgTableAnalyzerPage::IDD)
...
TADlgTableAnalyzerPage::~TADlgTableAnalyzerPage()
{
}
#pragma endregion Constructor

#pragma region Public Methods
bool TADlgTableAnalyzerPage::QueryAllowExit()
{
...
void TADlgTableAnalyzerPage::DoDataExchange(CDataExchange* pDX)
{
	CPropertyPage::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(TADlgTableAnalyzerPage)
...
BOOL TADlgTableAnalyzerPage::OnInitDialog()
{
...
void TADlgTableAnalyzerPage::OnButtonClearAll()
{
...
void TADlgTableAnalyzerPage::OnButtonDeleteCurrentAnalyzer()
{
...
void TADlgTableAnalyzerPage::OnButtonInsertNewAnalyzer()
{
...
void TADlgTableAnalyzerPage::OnSelchangeAnalyzerList()
{
	if (S_OK != prepareSwitchOfAnalyzerSelection())
	{
		return;
...
void TADlgTableAnalyzerPage::OnChangeColumnSelection()
{
...
void TADlgTableAnalyzerPage::OnButtonClickExcludeHigh()
{
	m_ExcludeHighWidget->OnButton();
}

void TADlgTableAnalyzerPage::OnButtonClickExcludeLow()
{
	m_ExcludeLowWidget->OnButton();
}

void TADlgTableAnalyzerPage::OnButtonClickLimitValue()
{
	m_LimitWidget->OnButton();
}

void TADlgTableAnalyzerPage::OnKillFocusExcludeHigh()
{
	m_ExcludeHighWidget->EditboxToValue();
}

void TADlgTableAnalyzerPage::OnKillFocusExcludeLow()
{
	m_ExcludeLowWidget->EditboxToValue();
}

void TADlgTableAnalyzerPage::OnKillFocusLimitValue()
{
	m_LimitWidget->EditboxToValue();
}

void TADlgTableAnalyzerPage::OnAddColumnFormula()
{
...
BOOL TADlgTableAnalyzerPage::OnSetActive()
{
	setSourceTableObjectId();
	refresh();
...
BOOL TADlgTableAnalyzerPage::OnKillActive()
{
	HRESULT hResult = SetInspectionData();
	if (S_OK == hResult)
	{
...
HRESULT TADlgTableAnalyzerPage::SetInspectionData()
{
	UpdateData(TRUE); // get data from dialog
...
void TADlgTableAnalyzerPage::refresh()
{
	SvUl::NameObjectIdList availableList = getTableAnalyzer();
...
void TADlgTableAnalyzerPage::SetPropertyControls()
{
	m_selectedSubType = SvPb::SVNotSetSubObjectType;
	if (SvDef::InvalidObjectId != m_selectedAnalyzerID)
	{
...
HRESULT TADlgTableAnalyzerPage::RetrieveAvailableColumnList()
{
	SvPb::InspectionCmdRequest requestCmd;
	SvPb::InspectionCmdResponse responseCmd;
	auto* pRequest = requestCmd.mutable_getavailableobjectsrequest();
...
void TADlgTableAnalyzerPage::ShowControls(long SubType)
{
...
void TADlgTableAnalyzerPage::resetValueController()
{
...
void TADlgTableAnalyzerPage::updateValueController()
{
...
void TADlgTableAnalyzerPage::setSortProperties()
{
...
void TADlgTableAnalyzerPage::setExcludeProperties()
{
	setColumnSelectionCB();
...
void TADlgTableAnalyzerPage::setLimitProperties()
{
	updateValueController();
}

void TADlgTableAnalyzerPage::setAddColumnProperties()
{
...
void TADlgTableAnalyzerPage::setDeleteColumnProperties()
{
...
void TADlgTableAnalyzerPage::setColumnSelectionCB(bool useSourceAvailable)
{
	RetrieveAvailableColumnList();
...
HRESULT TADlgTableAnalyzerPage::prepareSwitchOfAnalyzerSelection()
{
...
HRESULT TADlgTableAnalyzerPage::checkAllAnaylzer()
{
	HRESULT hrOk = S_OK;
...
HRESULT TADlgTableAnalyzerPage::SetAddAnalyzerData(SvStl::MessageContainerVector &rErrorMessageList)
{
	HRESULT hrOk = S_OK;
	if (nullptr != m_pSelectedAddEquationFormula)
	{
...
SvUl::NameObjectIdList TADlgTableAnalyzerPage::getTableAnalyzer()
{
	SvPb::InspectionCmdRequest requestCmd;
	SvPb::InspectionCmdResponse responseCmd;
	auto* pRequest = requestCmd.mutable_getavailableobjectsrequest();
...
void TADlgTableAnalyzerPage::setSourceTableObjectId()
{
	SvPb::InspectionCmdRequest requestCmd;
	SvPb::InspectionCmdResponse responseCmd;
