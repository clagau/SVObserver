...
/// \file TADlgGroupToolResultPage.cpp
/// This is the class for the input tab of Group Tool
//******************************************************************************

#pragma region Includes
#include "stdafx.h"
#include "TADlgGroupToolResultPage.h"
...
SvStl::MessageContainerVector getErrorMessage(uint32_t inspectionId, uint32_t toolId);
	...
	BEGIN_MESSAGE_MAP(TADlgGroupToolResultPage, CPropertyPage)
...
bool TADlgGroupToolResultPage::QueryAllowExit()
{
...
void TADlgGroupToolResultPage::DoDataExchange(CDataExchange* pDX)
{
	CPropertyPage::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(TADlgGroupToolResultPage)
	DDX_Control(pDX, IDC_GRID, m_Grid);
	DDX_Text(pDX, IDC_EDIT_COMMENT, m_strComment);
	//}}AFX_DATA_MAP
}

BOOL TADlgGroupToolResultPage::OnInitDialog()
{
...
BOOL TADlgGroupToolResultPage::OnSetActive()
{
...
BOOL TADlgGroupToolResultPage::OnKillActive()
{
...
void TADlgGroupToolResultPage::OnGridClick(NMHDR* pNotifyStruct, LRESULT*)
{
...
bool TADlgGroupToolResultPage::OnValueChanged(int row, int column)
{
...
void TADlgGroupToolResultPage::OnSelectionChanged(NMHDR*, LRESULT*)
{
	setInspectionData(false);
	UpdateEnableButtons();
}

void TADlgGroupToolResultPage::OnBnClickedButtonAdd()
{
...
void TADlgGroupToolResultPage::OnBnClickedButtonRemove()
{
...
void TADlgGroupToolResultPage::OnBnClickedMoveUp()
{
	SvGcl::CellRange Selection = m_Grid.GetSelectedCellRange();
...
void TADlgGroupToolResultPage::OnBnClickedMoveDown()
{
	SvGcl::CellRange Selection = m_Grid.GetSelectedCellRange();
...
void TADlgGroupToolResultPage::OnKillFocusComment()
{
	SvGcl::CellRange Selection = m_Grid.GetSelectedCellRange();
...
bool TADlgGroupToolResultPage::setInspectionData(bool displayMessageBox)
{
	UpdateData(TRUE);
	try
	{
...
void TADlgGroupToolResultPage::initGridControl()
{
...
void TADlgGroupToolResultPage::setGridControlReadOnlyFlag(int row, int column, bool isChangeable)
{
	if (isChangeable)
	{
...
void TADlgGroupToolResultPage::FillGridControl()
{
...
void TADlgGroupToolResultPage::setValueColumn(int pos)
{
...
SvDef::NameValuePair TADlgGroupToolResultPage::getType(const std::string& rTypeName)
{
...
void TADlgGroupToolResultPage::UpdateEnableButtons()
{
	SvGcl::CellRange Selection = m_Grid.GetSelectedCellRange();
