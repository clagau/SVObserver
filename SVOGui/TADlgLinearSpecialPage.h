...
//* .File Name       : $Workfile:   TADlgLinearSpecialPage.h  $
//* ----------------------------------------------------------------------------
...
namespace SvOg
{
	class TADlgLinearSpecialPage : public CPropertyPage
	{
	public:
		TADlgLinearSpecialPage(uint32_t inspectionId, uint32_t taskObjectId);
		virtual ~TADlgLinearSpecialPage();
	...
	protected:
		...
		//{{AFX_MSG(TADlgLinearSpecialPageClass)
