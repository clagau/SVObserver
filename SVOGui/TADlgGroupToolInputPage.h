...
/// \file TADlgGroupToolInputPage.h
...
namespace SvOg
{
	class TADlgGroupToolInputPage : public CPropertyPage, public ISVPropertyPageDialog
	{
#pragma region Declarations
	protected:
		//{{AFX_DATA(TADlgGroupToolInputPage)
...
#pragma region Constructor
	public:
		...
		TADlgGroupToolInputPage(uint32_t inspectionId, uint32_t toolId, uint32_t taskId, bool isModuleTool = false);

		// Standard destructor
		virtual ~TADlgGroupToolInputPage() = default;
...
#pragma region Protected Methods
		...
		//{{AFX_VIRTUAL(TADlgGroupToolInputPage)
	protected:
		virtual void DoDataExchange(CDataExchange* pDX) override;    // DDX/DDV-Unterstützung
																	 //}}AFX_VIRTUAL
	protected:
		//{{AFX_MSG(TADlgGroupToolInputPage)
...
#pragma region Member Variables
	private:
		...
		std::vector<SvOgu::GroupInputResultData> m_inputData;
