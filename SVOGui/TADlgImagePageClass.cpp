...
//* .File Name       : $Workfile:   TADlgImagePageClass.cpp  $
//* ----------------------------------------------------------------------------
...
BEGIN_MESSAGE_MAP(TADlgImagePageClass, CPropertyPage)
	//{{AFX_MSG_MAP(TADlgImagePageClass)
	ON_CBN_SELCHANGE(IDC_COMBO1, OnSelchangeCombo1)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

TADlgImagePageClass::TADlgImagePageClass(uint32_t inspectionId, uint32_t taskObjectId, SvPb::SVObjectSubTypeEnum SubType /*= SvPb::SVImageMonoType*/, int id /*=IDD*/)
	: CPropertyPage(id)
...
TADlgImagePageClass::~TADlgImagePageClass()
{}

HRESULT TADlgImagePageClass::SetInspectionData()
{
...
void TADlgImagePageClass::refresh()
{
	SetInspectionData();
	m_dialogImage.Refresh();
}

void TADlgImagePageClass::DoDataExchange(CDataExchange* pDX)
{
	CPropertyPage::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(TADlgImagePageClass)
	DDX_Control(pDX, IDC_COMBO1, m_availableSourceImageListBox);
	DDX_Control(pDX, IDC_DIALOGIMAGE, m_dialogImage);
	//}}AFX_DATA_MAP
}

BOOL TADlgImagePageClass::OnInitDialog()
{
...
void TADlgImagePageClass::OnSelchangeCombo1()
{
	UpdateData(TRUE); // get data from dialog
