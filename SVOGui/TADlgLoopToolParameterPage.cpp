...
#include "stdafx.h"
#include "TADlgLoopToolParameterPage.h"
...
BEGIN_MESSAGE_MAP(TADlgLoopToolParameterPage, CPropertyPage)
	//{{AFX_MSG_MAP(TADlgLoopToolParameterPage)
...
TADlgLoopToolParameterPage::TADlgLoopToolParameterPage(uint32_t inspectionID, uint32_t taskObjectID)
	: CPropertyPage(TADlgLoopToolParameterPage::IDD)
...
TADlgLoopToolParameterPage::~TADlgLoopToolParameterPage()
{
}



bool TADlgLoopToolParameterPage::QueryAllowExit()
{
...
void TADlgLoopToolParameterPage::DoDataExchange(CDataExchange* pDX)
{
...
BOOL TADlgLoopToolParameterPage::OnInitDialog()
{
...
BOOL TADlgLoopToolParameterPage::OnKillActive()
{
	HRESULT hResult = SetPageData();
	if (S_OK == hResult)
	{
...
HRESULT TADlgLoopToolParameterPage::SetPageData()
{
...
void TADlgLoopToolParameterPage::resetInspection()
{
...
void TADlgLoopToolParameterPage::OnBnClickedButtonBreakCondition()
{
	m_BreakConditionWidget->OnButton();
}

void TADlgLoopToolParameterPage::OnBnClickedButtonLastLoopCount()
{
	m_LoopsValueWidget->OnButton();
}

void TADlgLoopToolParameterPage::OnKillFocusBreakCondition()
{
	m_BreakConditionWidget->EditboxToValue();
}

void TADlgLoopToolParameterPage::OnKillFocusLastLoopCount()
{
