...
//* .File Name       : $Workfile:   TADlgPerspectiveWarpPage.cpp  $
//* ----------------------------------------------------------------------------
...
#include "stdafx.h"
#include "TADlgPerspectiveWarpPage.h"
...
namespace SvOg
{
	BEGIN_MESSAGE_MAP(TADlgPerspectiveWarpPage, CPropertyPage)
		//{{AFX_MSG_MAP(TADlgPerspectiveWarpPage)
	...
	TADlgPerspectiveWarpPage::TADlgPerspectiveWarpPage( uint32_t inspectionId, uint32_t taskObjectId, int ID ) 
	: CPropertyPage( ID )
	...
	TADlgPerspectiveWarpPage::~TADlgPerspectiveWarpPage()
	{
	}

	void TADlgPerspectiveWarpPage::SetInspectionData()
	{
	...
	void TADlgPerspectiveWarpPage::DoDataExchange(CDataExchange* pDX)
	{
		CPropertyPage::DoDataExchange(pDX);
		//{{AFX_DATA_MAP(TADlgPerspectiveWarpPage)
	...
	BOOL TADlgPerspectiveWarpPage::OnInitDialog() 
	{
	...
	void TADlgPerspectiveWarpPage::OnSelchangePerspectiveUnwarpTypeCombo() 
	{
		SetInspectionData();
	}


	void TADlgPerspectiveWarpPage::OnDestroy() 
	{
	...
	bool TADlgPerspectiveWarpPage::setExtentImageProperty(SvPb::SVExtentPropertyEnum eProperty, double value)
	{
	...
	void TADlgPerspectiveWarpPage::OnSelchangeInterpolationModeCombo() 
	{
		SetInspectionData();
	}
} //namespace SvOg
