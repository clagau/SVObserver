...
// ******************************************************************************
/*
$Log:   N:\PVCSarch65\ProjectFiles\archives\SVObserver_src\SVTVicLpt\SVTVicLptImpl.cpp_v  $
 * 
 *    Rev 1.2   13 May 2013 12:00:42   bWalter
 * Project:  SVObserver
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.20   07 May 2013 13:14:46   jspila
 * Project:  SVObserver
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.1   08 May 2013 15:58:36   bWalter
 * Project:  SVObserver
 * Change Request (SCR) nbr:  814
 * SCR Title:  Upgrade SVObserver to Compile Using Visual Studio 2010
 * Checked in by:  bWalter;  Ben Walter
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.19   29 Apr 2013 13:55:00   jspila
 * Project:  SVObserver
 * Change Request (SCR) nbr:  830
 * SCR Title:  Consolidate all Time Stamp and Clock Functionality
 * Checked in by:  Joe;  Joe Spila
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.0   25 Apr 2013 19:09:16   bWalter
 * Project:  SVObserver
 * Change Request (SCR) nbr:  814
 * SCR Title:  Upgrade SVObserver to Compile Using Visual Studio 2010
 * Checked in by:  bWalter;  Ben Walter
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.18   04 Oct 2012 10:27:48   jspila
 * Project:  SVObserver
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.17   23 Sep 2011 07:46:38   tbair
 * Project:  SVObserver
 * Change Request (SCR) nbr:  730
 * SCR Title:  Adjust SVObserver to fix issues with Inspection resource handshaking
 * Checked in by:  tBair;  Tom Bair
 * Change Description:  
 *   Added additional check to catch changing trigger inputs to prevent a delayed trigger.
 * 
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.16   26 May 2011 13:51:28   tbair
 * Project:  SVObserver
 * Change Request (SCR) nbr:  721
 * SCR Title:  Bug Fix for trigger initialization.
 * Checked in by:  tBair;  Tom Bair
 * Change Description:  
 *   Added initialization to the StartTrigger Function for last trigger state.
 * 
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.15   19 Jan 2010 15:51:30   jspila
 * Project:  SVObserver
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.14   04 Nov 2009 18:41:24   jspila
 * Project:  SVObserver
 * Change Request (SCR) nbr:  633
 * SCR Title:  Upgrade Intek FireStack Driver and API to version 2.32
 * Checked in by:  jSpila;  Joseph Spila
 * Change Description:  
 *   Fixed issues with trigger inversion.
 * 
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.13   02 Nov 2009 19:05:20   jspila
 * Project:  SVObserver
 * Change Request (SCR) nbr:  633
 * SCR Title:  Upgrade Intek FireStack Driver and API to version 2.32
 * Checked in by:  jSpila;  Joseph Spila
 * Change Description:  
 *   Updated code to fix trigger edge issue.
 * 
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.12   16 Oct 2009 12:36:20   jspila
 * Project:  SVObserver
 * Change Request (SCR) nbr:  666
 * SCR Title:  Change command format for  X-Series IO
 * Checked in by:  tBair;  Tom Bair
 * Change Description:  
 *   Updated to fix a problem with triggers.
 * 
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.11   16 Oct 2009 12:12:18   jspila
 * Project:  SVObserver
 * Change Request (SCR) nbr:  666
 * SCR Title:  Change command format for  X-Series IO
 * Checked in by:  tBair;  Tom Bair
 * Change Description:  
 *   Updated code to handle old hardware IO Interface board.
 * 
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.10   08 Oct 2009 15:24:12   tbair
 * Project:  SVObserver
 * Change Request (SCR) nbr:  666
 * SCR Title:  Change command format for  X-Series IO
 * Checked in by:  tBair;  Tom Bair
 * Change Description:  
 *   Fixed path issues for status library.
 * 
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.9   08 Oct 2009 11:59:56   tbair
 * Project:  SVObserver
 * Change Request (SCR) nbr:  666
 * SCR Title:  Change command format for  X-Series IO
 * Checked in by:  tBair;  Tom Bair
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.8   30 Jul 2009 09:33:26   jspila
 * Project:  SVObserver
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.7   25 Jun 2009 09:56:20   tbair
 * Project:  SVObserver
 * Change Request (SCR) nbr:  663
 * SCR Title:  Add support to SVTVicLpt dll to lock and unlock outputs.
 * Checked in by:  tBair;  Tom Bair
 * Change Description:  
 *   Fixed programming error that could cause a re-enterant call under an error condition.
 * 
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.6   22 May 2009 14:30:22   tbair
 * Project:  SVObserver
 * Change Request (SCR) nbr:  663
 * SCR Title:  Add support to SVTVicLpt dll to lock and unlock outputs.
 * Checked in by:  tBair;  Tom Bair
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.5   20 Jun 2007 15:15:24   Joe
 * Project:  SVObserver
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.4   23 Jan 2007 15:58:10   tbair
 * Project:  SVObserver
 * Change Request (SCR) nbr:  590
 * SCR Title:  Modify SVObserver to send the IO Board type to the parallel board
 * Checked in by:  tBair;  Tom Bair
 * Change Description:  
 *   Modified SetBoardType to use SET_SYSTEM_TYPE sub command.
 * 
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.3   24 Jul 2006 11:43:16   tbair
 * Project:  SVObserver
 * Change Request (SCR) nbr:  564
 * SCR Title:  Add configurability to SVTVicLpt DLL to set the system type
 * Checked in by:  tBair;  Tom Bair
 * Change Description:  
 *   Modified version format to show leading zero in firmware version number in GetParameterValue and 
 * TriggerGetParameterValue.
 * 
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.3   24 Jul 2006 11:43:06   tbair
 * Project:  SVObserver
 * Change Request (SCR) nbr:  564
 * SCR Title:  Add configurability to SVTVicLpt DLL to set the system type
 * Checked in by:  tBair;  Tom Bair
 ...
 * /////////////////////////////////////////////////////////////////////////////////////
 * 
 *    Rev 1.1   18 Nov 2005 07:22:20   tbair
 * Project:  SVObserver
