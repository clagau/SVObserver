...
//* All Rights Reserved
//******************************************************************************
//* .Module Name     : SVTempDirHelper
//* .File Name       : $Workfile:   SVTempDirHelper.h  $
//* ----------------------------------------------------------------------------
//* .Current Version : $Revision:   1.0  $
//* .Check In Date   : $Date:   14 Aug 2014 17:09:48  $
//******************************************************************************
///////////////////////////////////////////////////////////////////////////////////
// Paste the boost interprocess header
// (boost/interprocess/detail/tmp_dir_helpers.hpp)
// below and replace the function get_tmp_base_dir as follows

// /* Original Boost 1.5.2 code
...
// // Seidenader Vision code
// // change so that the location of the managed shared memory can be placed in the ram disk
// inline void get_tmp_base_dir(std::string &tmp_name)
// {
//	 const char* pLoc = std::getenv("SVSharedMemoryLocation");
//	 if (pLoc)
//	 {
//		 tmp_name = pLoc;
//	 }
//	 if (tmp_name.empty())
//	 {
//		 // iterate through the volume names and look for one named RamDisk-PAE ?
//		 tmp_name = "V:";
//	 }
//	 tmp_name += "/boost_interprocess";
// }
...
#include <cstdlib>
   ...
   //#include <boost/interprocess/detail/win32_api.hpp>
	#undef BOOST_INTERPROCESS_HAS_WINDOWS_KERNEL_BOOTTIME
	#undef BOOST_INTERPROCESS_HAS_KERNEL_BOOTTIME
...
//******************************************************************************
/*
$Log:   N:\PVCSarch65\ProjectFiles\archives\SVObserver_SRC\SVSharedMemoryLibrary\SVTempDirHelper.h_v  $
 * 
 *    Rev 1.0   14 Aug 2014 17:09:48   sjones
 * Project:  SVObserver
