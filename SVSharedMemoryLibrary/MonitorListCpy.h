...
namespace Seidenader { namespace SVSharedMemoryLibrary
{
	...
	public:	
		...
		int InsertToMLInspectionInfoMap(MLInspectionInfoMap & inspectionInfoMap) const;
	
		///Write the Monitorlist to the shared Memory 
		void WriteMonitorList(SVMonitorListWriter& rWriter) const;
		
		//Add a new Entry 
		MonitorEntryPointer  AddEntry(ListType::typ ltype, const SVString& name, DWORD type);
	...
	public:
		...
		MonitorEntriesMap m_EntriesMap; //< entry map with element from m_MonitorEntries 
