...
#define SV_ADAPT_TO_UNTESTED_DLL WM_USER + 40
#define SV_ADAPT_TO_TESTED_DLL WM_USER + 41
#define SV_SELECT_INPUT_VALUE_PAGE WM_USER + 42
#define SV_UPDATE_IPDOC_VIEWS WM_USER + 43
