...
namespace SvOi
{
	...
	void getToolDependency( StringPairInserter Inserter, const std::set<uint32_t>& rSourceSet, SvPb::SVObjectTypeEnum nameToObjectType, ToolDependencyEnum ToolDependency = Client, bool externalOnly = true, LPCTSTR fileName = nullptr);
